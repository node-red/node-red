...
/**
 * skipperin source code is derived from node-red httpin node.
...
module.exports = function(RED) {
    ...
    function createRequestWrapper(node,req) {
        ...
        toWrap.forEach(function(f) {
            if (typeof req[f] === "function") {
                wrapper[f] = function() {
                    node.warn(RED._("SkipperIn.errors.deprecated-call",{method:"msg.req."+f}));
    ...
    function createResponseWrapper(node,res) {
        ...
        toWrap.forEach(function(f) {
            wrapper[f] = function() {
                node.warn(RED._("SkipperIn.errors.deprecated-call",{method:"msg.res."+f}));
    ...
    function SkipperIn(n) {
        RED.nodes.createNode(this,n);
        if (RED.settings.httpNodeRoot !== false) {

            if (!n.url) {
                this.warn(RED._("SkipperIn.errors.missing-path"));
                return;
            }
            this.url = n.url;
            ...
            this.warn(RED._("SkipperIn.errors.not-created"));
        }
    }
    RED.nodes.registerType("skipper in",SkipperIn);
}
