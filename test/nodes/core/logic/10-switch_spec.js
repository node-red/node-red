...
describe('SwitchNode', function() {
    ...
    it('should match iregex', function(done) {
        genericSwitchTest("iregex", "^[abc]+$", true, true, "aBbAbAc", done);
    });

    it('should return nothing when the payload doesn\'t match iregex', function(done) {
        genericSwitchTest("iregex", "^[abc]+$", true, false, "aBbZAbAc", done);
    });
