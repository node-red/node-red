        ...
        if (exclusion.indexOf(def.category)===-1) {
          ...
          if($("#palette-base-category-"+category[0]).length == 0){
            $("#palette-container").append('\
              ...
              <div id="header-'+category[0]+'" class="palette-header"><i class="expanded icon-chevron-down"></i><span>'+category[0]+'</span></div>\
              <div class="palette-content" id="palette-base-category-'+category[0]+'"></div>\
              </div>');
          }
