    ...
    function createTabs(options) {
        ...
        return {
            addTab: function(tab) {
                ...
                span = span.html(RED.bidi.applyBidiSupport(tab.label, RED.bidi.flags.BTD | RED.bidi.flags.NS)).appendTo(link);
            ...
            renameTab: function(id,label) {
                ...
                tab.find("span").html(RED.bidi.applyBidiSupport(label, RED.bidi.flags.BTD | RED.bidi.flags.NS));
                updateTabWidths();
            },
