...
<link rel="preload" href="vendor/monaco/dist/editor.js?v={{ cacheBuster }}" as="script">
{{/asset.vendorMonaco}}
</head>
...
{{#asset.vendorMonaco}}
<script id="monaco-bootstrap" src="{{{ asset.vendorMonaco }}}?v={{ cacheBuster }}"></script>
{{/asset.vendorMonaco}}
{{#asset.vendorAce}}
<script id="ace-bootstrap" src="{{{ asset.vendorAce }}}?v={{ cacheBuster }}"></script>
{{/asset.vendorAce}}
