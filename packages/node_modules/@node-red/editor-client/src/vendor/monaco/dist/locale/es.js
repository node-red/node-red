this.MonacoEnvironment = this.MonacoEnvironment || {}; this.MonacoEnvironment.Locale = {language: 'es', data: {
    ...
    "vs/editor/common/config/editorOptions": {
        ...
        "inlineHints.enable": "Habilita las sugerencias insertadas en el editor.",
        "inlineHints.fontSize": "Controla el tamaño de fuente de las sugerencias insertadas en el editor. Cuando se establece en \"0\", se usa el 90 % de \"#editor.fontSize#\".",
        "inlineHints.fontFamily": "Controla la familia de fuentes de las sugerencias insertadas en el editor.",
    ...
    "vs/platform/theme/common/colorRegistry": {
        ...
        "editorInlineHintForeground": "Color de primer plano de las sugerencias insertadas",
        "editorInlineHintBackground": "Color de fondo de las sugerencias insertadas",
