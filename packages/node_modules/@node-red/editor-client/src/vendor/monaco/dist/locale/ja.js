...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "minimap.markSectionHeaderRegex": "コメント内のセクション ヘッダーを検索するために使用する正規表現を定義します。正規表現には、セクション ヘッダーをカプセル化する名前付き一致グループ 'label' ('(?<label>.+)' と記述) が含まれている必要があります。それ以外の場合は機能しません。必要に応じて、'separator' という名前の別の一致グループを含めることができます。パターン内の \\n を使用して、複数行のヘッダーを照合します。",
  ...
  "vs/editor/common/standaloneStrings": {
    ...
    "suggestActionsKb": "候補のウィジェット{0} をトリガーして、考えられるコード入力候補を表示します。",
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/commands": {
    ...
    "action.inlineSuggest.trigger.explicitInlineEdit": "次の編集候補のトリガー",
    "jump": "ジャンプ",
  ...
  "vs/editor/contrib/peekView/browser/peekView": {
    ...
    "peekViewEditorStickyScrollGutterBackground": "ピーク ビュー エディターでの固定スクロールのガター部分の背景色。",
  ...
  "vs/platform/contextkey/common/contextkeys": {
    ...
    "isSimulation": "アプリケーションがシミュレーション モードで実行されるかどうか",
  ...
  "vs/platform/theme/common/colors/editorColors": {
    ...
    "editorStickyScrollGutterBackground": "エディターにおける固定スクロールのガター部分の背景色",
