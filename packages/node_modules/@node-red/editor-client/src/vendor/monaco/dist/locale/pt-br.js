...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorConfigurationSchema": {
    ...
    "editor.experimental.preferTreeSitter.css": "Controla se a análise do tree-sitter deve ser ativada para css. Isso terá prioridade sobre `#editor.experimental.treeSitterTelemetry#` para css.",
    "editor.experimental.preferTreeSitter.ini": "Controla se a analise do tree-sitter deve ser ativado para ini. Isso terá prioridade sobre `#editor.experimental.treeSitterTelemetry#` para ini.",
    "editor.experimental.preferTreeSitter.regex": "Controla se a análise do tree-sitter deve ser ativada para regex. Isso terá prioridade sobre `#editor.experimental.treeSitterTelemetry#` para regex.",
    "editor.experimental.preferTreeSitter.typescript": "Controla se a analise do tree-sitter deve ser ativado para typeScript. Isso terá prioridade sobre `#editor.experimental.treeSitterTelemetry#` para typeScript.",
    "editor.experimental.treeSitterTelemetry": "Controla se a análise do tree-sitter deve ser ativada e se a telemetria deve ser coletada. Configurar `#editor.experimental.preferTreeSitter#` para linguagens específicas terá prioridade.",
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "allowVariableFonts": "Controlar se o uso de fontes variáveis no editor é permitido.",
    "allowVariableFontsInAccessibilityMode": "Controlar se o uso de fontes variáveis no editor no modo de acessibilidade é permitido.",
    "allowVariableLineHeights": "Controla se é permitido usar alturas de linha variáveis no editor.",
    ...
    "autoIndentOnPaste": "Controla se o editor deve recuar automaticamente o conteúdo colado automaticamente.",
    "autoIndentOnPasteWithinString": "Controla se o editor deve recuar automaticamente o conteúdo colado automaticamente quando colado em uma cadeia de caracteres. Isso entra em vigor quando autoIndentOnPaste é true.",
    ...
    "cursorHeight": "Controla a altura do cursor quando `#editor.cursorStyle#` está definido como `line`. A altura máxima do cursor depende da altura da linha.",
    ...
    "cursorStyle": "Controla o estilo do cursor no modo inserção de entrada.",
    ...
    "defaultColorDecorators": "Controla se as decorações de cor embutidas devem ser exibidas usando o provedor de cores padrão do documento.",
    ...
    "editContext": "Define se a API EditContext deve ser usada em vez da área de texto para ligar a entrada no editor.",
    ...
    "editor.defaultColorDecorators.always": "Sempre mostrar decoradores de cor padrão.",
    "editor.defaultColorDecorators.auto": "Mostrar decoradores de cor padrão somente quando nenhuma extensão fornecer decoradores de cores.",
    "editor.defaultColorDecorators.never": "Nunca mostrar decoradores de cor padrão.",
    ...
    "editor.find.history.never": "Não armazene o histórico de pesquisa do widget de localização.",
    "editor.find.history.workspace": "Armazenar histórico de pesquisa no workspace ativo",
    "editor.find.replaceHistory.never": "Não armazenar o histórico do widget de substituição.",
    "editor.find.replaceHistory.workspace": "Armazenar o histórico de substituição em todo o workspace ativo",
    ...
    "editor.inlineSuggest.edits.renderSideBySide.auto": "Sugestões maiores serão exibidas lado a lado se houver espaço suficiente; caso contrário, elas aparecerão abaixo.",
    "editor.inlineSuggest.edits.renderSideBySide.never": "Sugestões maiores nunca são exibidas lado a lado e sempre aparecerão abaixo.",
    ...
    "experimentalGpuAcceleration": "Controla se a aceleração de GPU experimental deve ser usada para renderizar o editor.",
    "experimentalGpuAcceleration.off": "Use renderização regular baseada em DOM.",
    "experimentalGpuAcceleration.on": "Usar aceleração de GPU.",
    ...
    "find.findOnType": "Controla se o Widget de Localização deve pesquisar conforme você for digitando.",
    ...
    "find.history": "Controla como o histórico de widgets de localização deve ser armazenado",
    ...
    "find.replaceHistory": "Controla como o histórico de widgets de substituição deve ser armazenado",
    ...
    "hover.hidingDelay": "Controla o atraso, em milissegundos, após o qual o foco é ocultado. Exige que `#editor.hover.sticky#` esteja habilitado.",
    "hover.sticky": "Controla se o foco deve permanecer visível quando o mouse é movido sobre ele.",
    "inertialScroll": "Torne a rolagem inercial – especialmente útil com touchpad no Linux.",
    ...
    "inlineSuggest.edits.allowCodeShifting": "Controla se a exibição de uma sugestão deslocará o código para abrir espaço para a sugestão embutida.",
    "inlineSuggest.edits.renderSideBySide": "Controla se sugestões maiores podem ser mostradas lado a lado.",
    "inlineSuggest.edits.showCollapsed": "Controla se a sugestão será mostrada como recolhida até saltar para ela.",
    ...
    "inlineSuggest.minShowDelay": "Controla o atraso mínimo, em milissegundos, após o qual as sugestões embutidas são exibidas após a digitação.",
    "inlineSuggest.showOnSuggestConflict": "Controla se as sugestões embutidas devem ser mostradas quando há um conflito de sugestão.",
    ...
    "inlineSuggest.suppressInlineSuggestions": "Suprime conclusões embutidas para IDs de extensão especificadas – separados por vírgulas.",
    ...
    "inlineSuggest.triggerCommandOnProviderChange": "Controlar se um comando deve ser disparado quando o provedor de sugestões embutidas for alterado.",
    ...
    "minimap.autohide.mouseover": "O minimapa fica oculto quando o mouse não está sobre o minimapa e é mostrado quando o mouse está sobre o minimapa.",
    "minimap.autohide.none": "O minimapa sempre é mostrado.",
    "minimap.autohide.scroll": "O minimapa só é mostrado quando o editor é rolado",
    "minimap.enabled": "Controla se o minimapa é exibido.",
    "minimap.markSectionHeaderRegex": "Define a expressão regular usada para localizar cabeçalhos de seção nos comentários. O regex deve conter um grupo de correspondência nomeado 'label' (escrito como '(?<label>.+)') que encapsula o cabeçalho da seção, caso contrário, ele não funcionará. Opcionalmente, você pode incluir outro grupo de correspondência chamado 'separador'. Use \\n padrão para corresponder cabeçalhos de várias linhas.",
    ...
    "occurrencesHighlightDelay": "Controla o atraso em milissegundos após o qual as ocorrências são realçadas.",
    "off": "As Sugestões rápidas estão desabilitadas",
    "on": "As Sugestões rápidas são mostradas dentro do widget de sugestão",
    "overtypeCursorStyle": "Controla o estilo do cursor no modo sobrescrever de entrada.",
    "overtypeOnPaste": "Controla se a colagem deve sobrescrever.",
    ...
    "renameOnTypeDeprecate": "Obsoleto, use `#editor.linkedEditing#` em vez disso.",
    ...
    "renderRichScreenReaderContent": "Se deve renderizar conteúdo avançado para leitores de tela quando a configuração `#editor.editContext#` estiver habilitada.",
    ...
    "scrollOnMiddleClick": "Controla se o editor rolará quando o botão do meio for pressionado.",
    ...
    "selectionHighlightMaxLength": "Controla quantos caracteres podem estar na seleção antes que correspondências semelhantes não sejam realçadas. Defina como zero para ilimitado.",
    "selectionHighlightMultiline": "Controla se o editor deve realçar correspondências de seleção que abrangem várias linhas.",
    ...
    "suggest.selectionMode": "Controla se uma sugestão é selecionada quando o widget é exibido. Observe que isso só se aplica a sugestões disparadas automaticamente ({0} e {1}) e que uma sugestão é sempre selecionada quando invocada explicitamente, por exemplo, por meio de 'Ctrl+Espaço'.",
    ...
    "trimWhitespaceOnDelete": "Controla se o editor também excluirá o espaço em branco de recuo da próxima linha ao excluir uma nova linha.",
  ...
  "vs/editor/common/languages": {
    ...
    "suggestWidget.kind.color": "Cor",
    "suggestWidget.kind.constant": "Constante",
    "suggestWidget.kind.constructor": "Construtor",
    "suggestWidget.kind.customcolor": "Cor Personalizada",
    "suggestWidget.kind.enum": "Enumeração",
    "suggestWidget.kind.enumMember": "Membro da Enumeração",
    "suggestWidget.kind.event": "Evento",
    "suggestWidget.kind.field": "Campo",
    "suggestWidget.kind.file": "Arquivo",
    "suggestWidget.kind.folder": "Pasta",
    "suggestWidget.kind.function": "Função",
    "suggestWidget.kind.interface": "Interface",
    "suggestWidget.kind.issue": "Problema",
    "suggestWidget.kind.keyword": "Palavra-chave",
    "suggestWidget.kind.method": "Método",
    "suggestWidget.kind.module": "Módulo",
    "suggestWidget.kind.operator": "Operador",
    "suggestWidget.kind.property": "Propriedade",
    "suggestWidget.kind.reference": "Referência",
    "suggestWidget.kind.snippet": "Trecho",
    "suggestWidget.kind.struct": "Struct",
    "suggestWidget.kind.text": "Texto",
    "suggestWidget.kind.tool": "Ferramenta",
    "suggestWidget.kind.typeParameter": "Parâmetro de Tipo",
    "suggestWidget.kind.unit": "Unidade",
    "suggestWidget.kind.user": "Usuário",
    "suggestWidget.kind.value": "Valor",
    "suggestWidget.kind.variable": "Variável",
    "symbolAriaLabel": "{0} ({1})"
  },
  ...
  "vs/editor/common/standaloneStrings": {
    "acceptSuggestAction": "Aceitar sugestão{0} aceitar a sugestão selecionada no momento.",
    ...
    "chatEditing.navigation": "Navegue entre edições no editor com navegação anterior{0} e próxima{1} e aceite{2}, rejeite{3} ou exiba a diferença{4} para a alteração atual. Aceitar edições em todos os arquivos{5}.",
    "chatEditorModification": "O editor contém modificações pendentes que foram feitas por chat.",
    "chatEditorRequestInProgress": "O editor está aguardando que as modificações sejam feitas por chat.",
    ...
    "defaultWindowTitleExcludingEditorState": "activeEditorState — como modificado e problemas, dentro outros, não está incluído atualmente como parte da configuração window.title por padrão. Habilite-o com accessibility.windowTitleOptimized.",
    "defaultWindowTitleIncludesEditorState": "activeEditorState — como modificado e problemas, dentre outros, é incluído como parte da configuração window.title por padrão. Desabilite-o com accessibility.windowTitleOptimized.",
    ...
    "quickChatCommand": "Alternar o chat rápido{0} para abrir ou fechar uma sessão de chat.",
    ...
    "showOrFocusHover": "Mostrar ou focalizar o ponteiro do mouse{0} para ler informações sobre o símbolo atual.",
    "startInlineChatCommand": "Iniciar o chat embutido{0} para criar uma sessão de chat no editor.",
    "stickScrollKb": "A Rolagem Autoadesiva{0} para foco para nos escopos aninhados no momento.",
    "suggestActionsKb": "Dispare o widget de sugestão{0} mostrar possíveis conclusões de código.",
    ...
    "toggleSuggestionFocus": "Alterne o foco entre o widget de sugestão e o editor{0} e ative/desative o foco dos detalhes com{1} para saber mais sobre a sugestão.",
    "toolbar": "Ao redor do workbench, quando o leitor de tela anunciar que você parou em uma barra de ferramentas, use teclas estreitas para navegar entre as ações da barra de ferramentas."
  },
  ...
  "vs/editor/contrib/codeAction/browser/codeActionCommands": {
    ...
    "organizeImports.description": "Organize as importações no arquivo atual. Também chamado de \"Otimizar Importações\" por algumas ferramentas",
  ...
  "vs/editor/contrib/dropOrPasteInto/browser/copyPasteController": {
    ...
    "pasteIntoEditorProgress": "Executando manipuladores de colagem. Clique para cancelar e fazer uma colagem básica",
    "pasteWidgetVisible": "Se o widget de colagem está sendo exibido",
    "postPasteWidgetTitle": "Mostrar opções de colagem...",
    "resolveProcess": "Resolvendo a edição de colagem para '{0}'. Clique para cancelar"
  },
  ...
  "vs/editor/contrib/hover/browser/markdownHoverParticipant": {
    ...
    "decreaseVerbosity": "Diminuir o Detalhamento do Foco",
    "decreaseVerbosityWithKb": "Diminuição do Detalhamento do Foco ({0})",
    "increaseHoverVerbosity": "Ícone para aumentar o detalhamento do foco.",
    "increaseVerbosity": "Aumentar o Detalhamento do Foco",
    "increaseVerbosityWithKb": "Aumento do Detalhamento do Foco ({0})",
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/commands": {
    ...
    "action.inlineSuggest.dev.extractRepro": "Desenvolvedor: Extrair Estado de Sugestão Embutido",
    ...
    "action.inlineSuggest.toggleShowCollapsed": "Ativar/Desativar Sugestões Embutidas Mostrar Recolhidos",
    "action.inlineSuggest.trigger": "Disparar a Sugestão Embutida",
    "action.inlineSuggest.trigger.explicitInlineEdit": "Disparar Próxima Sugestão de Edição",
    "jump": "Pular",
    "noInlineEditAvailable": "Nenhuma edição em linha está disponível.",
    "reject": "Reject"
  },
  "vs/editor/contrib/inlineCompletions/browser/controller/inlineCompletionContextKeys": {
    "cursorAtInlineEdit": "Se o cursor está em uma edição em linha",
    "cursorBeforeGhostText": "Se o cursor está em texto fantasma",
    "cursorInIndentation": "Se o cursor está com recuo",
    "editor.hasSelection": "Se o editor tem uma seleção",
    "inInlineEditsPreviewEditor": "Se o editor de código atual está mostrando uma visualização de edições embutidas",
    ...
    "tabShouldAcceptInlineEdit": "Se a guia deve aceitar a edição em linha.",
    "tabShouldJumpToInlineEdit": "Se a guia deve ir para uma edição em linha."
  },
  ...
  "vs/editor/contrib/linesOperations/browser/linesOperations": {
    ...
    "lines.reverseLines": "Linhas inversas",
  ...
  "vs/editor/contrib/multicursor/browser/multicursor": {
    ...
    "addSelectionToPreviousFindMatch": "Adicionar Seleção à Correspondência de Busca Anterior",
    ...
    "moveSelectionToNextFindMatch": "Mover a Última Seleção para a Próxima Correspondência de Busca",
    "moveSelectionToPreviousFindMatch": "Mover a Última Seleção para a Correspondência de Busca Anterior",
    "mutlicursor.addCursorsToBottom": "Adicionar Cursores à Parte Inferior",
    "mutlicursor.addCursorsToTop": "Adicionar Cursores ao Topo",
  ...
  "vs/editor/contrib/peekView/browser/peekView": {
    ...
    "peekViewEditorStickyScrollGutterBackground": "Cor de fundo da parte medianiz da rolagem fixa no editor de espiada.",
  ...
  "vs/editor/contrib/stickyScroll/browser/stickyScrollActions": {
    "focusStickyScroll": "Rolagem Fixa do Editor de Foco",
    "goToFocusedStickyScrollLine.title": "Vá para a linha de rolagem fixa em foco",
    "miStickyScroll": "&&Rolagem Fixa",
    "mifocusEditorStickyScroll": "&&Rolagem Fixa do Editor de Foco",
  ...
  "vs/editor/contrib/suggest/browser/wordContextKey": {
    "desc": "Uma chave de contexto que é verdadeira quando no final de uma palavra. Observe que isso só é definido quando as conclusões de tabulação estão habilitadas"
  },
  ...
  "vs/platform/accessibilitySignal/browser/accessibilitySignalService": {
    "accessibility.signals.chatEditModifiedFile": "Arquivo Modificado de Edições de Chat",
    "accessibility.signals.chatRequestSent": "Solicitação de Chat Enviada",
    "accessibility.signals.chatUserActionRequired": "Ação do usuário no chat necessária",
    "accessibility.signals.clear": "Limpar",
    "accessibility.signals.codeActionRequestTriggered": "Solicitação de Ação de Código Disparada",
    "accessibility.signals.editsKept": "Edições Mantidas",
    "accessibility.signals.editsUndone": "Edições Desfeitas",
    ...
    "accessibility.signals.nextEditSuggestion": "Próxima Sugestão de Edição",
    ...
    "accessibilitySignals.chatEditModifiedFile": "Chat - Editar Arquivo Modificado",
    ...
    "accessibilitySignals.chatUserActionRequired": "Ação do usuário no chat necessária",
    "accessibilitySignals.clear": "Claro",
    "accessibilitySignals.codeActionApplied": "Ação de Código Aplicada",
    "accessibilitySignals.codeActionRequestTriggered": "Solicitação de Ação de Código Disparada",
    ...
    "accessibilitySignals.editsKept": "Edições Mantidas",
    "accessibilitySignals.editsUndone": "Desfazer Edições",
    ...
    "accessibilitySignals.nextEditSuggestion.name": "Próxima Sugestão de Edição na Linha",
  ...
  "vs/platform/configuration/common/configurationRegistry": {
    ...
    "defaultLanguageConfiguration.description": "Configurar as configurações a serem substituídas para {0}.",
  ...
  "vs/platform/contextkey/common/contextkeys": {
    ...
    "isSimulation": "Se o aplicativo é executado no modo de simulação",
  ...
  "vs/platform/list/browser/listService": {
    ...
    "sticky scroll maximum items": "Controla o número de elementos autoadesivos exibidos na árvore quando {0} está habilitado.",
  ...
  "vs/platform/markers/common/markers": {
    ...
    "sev.infos": "Informações",
    "sev.warning": "Aviso",
    "sev.warnings": "Avisos"
  },
  "vs/platform/markers/common/markerService": {
    "filtered": "Os problemas estão em pausa porque: \"{0}\"",
    "filtered.network": "Os problemas estão em pausa porque: \"{0}\" e mais {1}"
  },
  "vs/platform/notification/common/notification": {
    "severityPrefix.error": "Erro: {0}",
    "severityPrefix.info": "Informações: {0}",
    "severityPrefix.warning": "Aviso: {0}"
  },
  ...
  "vs/platform/quickinput/browser/quickInput": {
    ...
    "quickInputAlignment": "O alinhamento da entrada rápida",
  ...
  "vs/platform/theme/common/colors/editorColors": {
    ...
    "editorCompositionBorder": "A cor da borda de uma composição IME.",
    ...
    "editorStickyScrollGutterBackground": "Cor de fundo da parte medianiz da rolagem fixa no editor",
  ...
  "vs/platform/theme/common/colors/inputColors": {
    ...
    "checkbox.disabled.background": "Tela de fundo de uma caixa de seleção desabilitada.",
    "checkbox.disabled.foreground": "Primeiro plano de uma caixa de seleção desabilitada.",
  ...
  "vs/platform/theme/common/colors/miscColors": {
    "activityErrorBadge.background": "Cor da tela de fundo do selo de atividade de erro",
    "activityErrorBadge.foreground": "Cor de primeiro plano do selo de atividade de erro",
    "activityWarningBadge.background": "Cor da tela de fundo do selo de atividade de aviso",
    "activityWarningBadge.foreground": "Cor de primeiro plano do selo de atividade de aviso",
    ...
    "chartAxis": "Cor do eixo do gráfico.",
    "chartGuide": "Linha de guia para o gráfico.",
    "chartLine": "Cor da linha do gráfico.",
  ...
  "vs/platform/theme/common/iconRegistry": {
    ...
    "schema.fontId.formatError": "A ID da fonte deve conter apenas letras, números, sublinhados e traços.",
