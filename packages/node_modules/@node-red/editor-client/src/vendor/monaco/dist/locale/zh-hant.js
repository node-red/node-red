...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "使用編輯器的水平捲軸，啟用自黏捲動小工具的捲動。",
    ...
    "hover.hidingDelay": "控制隱藏暫留之後的延遲毫秒。需要啟用 'editor.hover.sticky'。",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "啟用/停用目前不在診斷時顯示行內最接近的 Quickfix。",
  ...
  "vs/platform/audioCues/browser/audioCueService": {
    "audioCues.chatRequestSent": "聊天要求已傳送",
    "audioCues.chatResponsePending": "聊天回應擱置中",
    "audioCues.chatResponseReceived": "聊天回應已接收",
