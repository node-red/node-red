...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "allowVariableFonts": "控制是否允許在編輯器中使用變數字型。",
    "allowVariableFontsInAccessibilityMode": "控制是否允許在協助工具模式中的編輯器使用變數字型。",
    "allowVariableLineHeights": "控制是否允許在編輯器中使用可變行高。",
    ...
    "autoIndentOnPaste": "控制編輯器是否應自動將貼上的內容自動縮排。",
    "autoIndentOnPasteWithinString": "控制在字串中貼上內容時，編輯器是否應自動將貼上的內容自動縮排。當 autoIndentOnPaste 為 True 時，此功能會生效。",
    ...
    "cursorHeight": "控制游標高度，當`#editor.cursorStyle#` 設定為 `line` 時。游標的最大高度取決於行高。",
    ...
    "editContext": "設定是否應使用 EditContext API，而不是文字區域來支援編輯器中的輸入。",
    ...
    "find.findOnType": "控制 [尋找小工具] 是否應在您輸入時進行搜尋。",
    ...
    "inertialScroll": "將捲動設為慣性 - 主要適用於 Linux 上的觸控板。",
    ...
    "inlineSuggest.minShowDelay": "控制輸入後顯示內嵌建議的最小延遲時間 (以毫秒為單位)。",
    "inlineSuggest.showOnSuggestConflict": "控制在建議衝突時是否顯示內嵌建議。",
    ...
    "inlineSuggest.suppressInlineSuggestions": "抑制指定擴充功能的內嵌完成 -- 以逗號分隔。",
    ...
    "inlineSuggest.triggerCommandOnProviderChange": "控制是否在內嵌建議提供者變更時觸發命令。",
    ...
    "minimap.autohide.mouseover": "當滑鼠不在檔案縮圖上時，檔案縮圖會隱藏；當滑鼠在檔案縮圖上時，檔案縮圖會顯示。",
    "minimap.autohide.none": "一律顯示檔案縮圖。",
    "minimap.autohide.scroll": "只有在捲動編輯器時，才會顯示檔案縮圖",
    ...
    "renderRichScreenReaderContent": "啟用 `#editor.editContext#` 設定時，是否要轉譯豐富的螢幕閱讀程式內容。",
    ...
    "scrollOnMiddleClick": "控制當按下中間按鈕時，編輯器是否會捲軸。",
    ...
    "selectionHighlightMaxLength": "控制在未醒目提示類似符合項目之前，選取範圍中可包含的字元數。設定為零以表示無限制。",
    "selectionHighlightMultiline": "控制編輯器是否應醒目提示跨越多行的選取範圍符合項目。",
    ...
    "trimWhitespaceOnDelete": "控制編輯器在刪除新行時是否也會刪除下一行的縮排空格。",
    ...
    "wrapOnEscapedLineFeeds": "控制啟用 `#editor.wordWrap#` 時，常值 `\\n` 是否應該觸發 wordWrap。\r\n\r\n例如:\r\n```c\r\nchar* str=\"hello\\nworld\"\r\n```\r\n會顯示為\r\n```c\r\nchar* str=\"hello\\n\r\n           world\"\r\n```",
  ...
  "vs/editor/common/standaloneStrings": {
    ...
    "chatEditing.navigation": "在編輯器中的編輯之間瀏覽，瀏覽上一個 {0} 和下一個 {1} 並接受{2}、拒絕{3}或檢視目前變更的差異{4}。接受所有檔案的編輯{5}。",
    ...
    "toolbar": "在 workbench 周圍，當螢幕助讀程式宣告您已在工具列中執行時，使用窄鍵在工具列的動作之間流覽。"
  },
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/inlineCompletionContextKeys": {
    ...
    "cursorBeforeGhostText": "游標是否位於預設提示文字上",
  ...
  "vs/editor/contrib/peekView/browser/peekView": {
    ...
    "peekViewEditorStickyScrollGutterBackground": "預覽檢視編輯器中黏性滾動的裝訂邊部分的背景色彩。",
  ...
  "vs/platform/accessibilitySignal/browser/accessibilitySignalService": {
    "accessibility.signals.chatEditModifiedFile": "從聊天編輯修改的檔案",
    "accessibility.signals.chatRequestSent": "聊天要求已傳送",
    "accessibility.signals.chatUserActionRequired": "需要聊天使用者動作",
    "accessibility.signals.clear": "清除",
    "accessibility.signals.codeActionRequestTriggered": "程式碼動作要求已觸發",
    "accessibility.signals.editsKept": "編輯已保留",
    "accessibility.signals.editsUndone": "編輯已復原",
    ...
    "accessibility.signals.nextEditSuggestion": "下一個編輯建議",
    ...
    "accessibilitySignals.chatUserActionRequired": "需要聊天使用者動作",
    ...
    "accessibilitySignals.nextEditSuggestion.name": "行上的下一個編輯建議",
  ...
  "vs/platform/configuration/common/configurationRegistry": {
    ...
    "defaultLanguageConfiguration.description": "設定要針對 {0} 覆寫的設定。",
  ...
  "vs/platform/notification/common/notification": {
    "severityPrefix.error": "錯誤: {0}",
    "severityPrefix.info": "資訊: {0}",
  ...
  "vs/platform/theme/common/colors/editorColors": {
    ...
    "editorStickyScrollGutterBackground": "編輯器中黏性滾動的裝訂邊部分的背景色彩",
  ...
  "vs/platform/theme/common/colors/inputColors": {
    ...
    "checkbox.disabled.background": "停用複選方塊的背景。",
    "checkbox.disabled.foreground": "停用複選方塊的前景。",
