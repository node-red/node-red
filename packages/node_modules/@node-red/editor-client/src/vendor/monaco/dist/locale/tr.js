this.MonacoEnvironment = this.MonacoEnvironment || {}; this.MonacoEnvironment.Locale = {language: 'tr', data: {
    ...
    "vs/editor/common/config/editorOptions": {
        ...
        "inlineHints.enable": "Düzenleyicideki satır içi ipuçlarını etkinleştirir.",
        "inlineHints.fontSize": "Düzenleyicideki satır içi ipuçlarının yazı tipi boyutunu denetler. `0` olarak ayarlandığında, `#editor.fontSize#` değerinin %90'ı kullanılır.",
        "inlineHints.fontFamily": "Düzenleyicideki satır içi ipuçlarının yazı tipi ailesini denetler.",
    ...
    "vs/platform/theme/common/colorRegistry": {
        ...
        "editorInlineHintForeground": "Satır içi ipuçlarının ön plan rengi",
        "editorInlineHintBackground": "Satır içi ipuçlarının arka plan rengi",
