...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorConfigurationSchema": {
    ...
    "editor.experimental.preferTreeSitter.css": "Tree sitter ayrıştırma özelliğinin css için açılmasının gerekip gerekmediğini denetler. Bu, css için `#editor.experimental.treeSitterTelemetry#` öğesine göre öncelik kazanır.",
    "editor.experimental.preferTreeSitter.ini": "Tree sitter ayrıştırma özelliğinin ini için açılmasının gerekip gerekmediğini denetler. Bu, ini için `#editor.experimental.treeSitterTelemetry#` öğesine göre öncelik kazanır.",
    "editor.experimental.preferTreeSitter.regex": "Tree sitter ayrıştırma özelliğinin regex için açılmasının gerekip gerekmediğini denetler. Bu, regex için `#editor.experimental.treeSitterTelemetry#` öğesine göre öncelik kazanır.",
    "editor.experimental.preferTreeSitter.typescript": "Tree sitter ayrıştırma özelliğinin typescript için açılmasının gerekip gerekmediğini denetler. Bu, typescript için `#editor.experimental.treeSitterTelemetry#` öğesine göre öncelik kazanır.",
    "editor.experimental.treeSitterTelemetry": "Tree sitter ayrıştırma özelliğinin açılmasının ve telemetri toplanmasının gerekip gerekmediğini denetler. Belirli dillerde `#editor.experimental.preferTreeSitter#` ayarı önceliklidir.",
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "allowVariableFonts": "Düzenleyicide değişken yazı tiplerinin kullanımına izin verilip verilmeyeceğini denetler.",
    "allowVariableFontsInAccessibilityMode": "Erişilebilirlik modunda düzenleyicide değişken yazı tiplerinin kullanımına izin verilip verilmeyeceğini denetler.",
    "allowVariableLineHeights": "Düzenleyicide değişken satır yüksekliklerinin kullanımına izin verilip verilmeyeceğini denetler.",
    ...
    "autoIndentOnPaste": "Düzenleyicinin yapıştırılan içeriği otomatik olarak girintileyip girintilemeyeceğini denetler.",
    "autoIndentOnPasteWithinString": "Dizgi içine yapıştırıldığında düzenleyicinin yapıştırılan içeriği otomatik olarak girintileyip girintilemeyeceğini denetler. Bu, autoIndentOnPaste true olduğunda geçerlidir.",
    ...
    "cursorHeight": "`#editor.cursorStyle#` `line` olarak ayarlandığında imlecin yüksekliğini denetler. İmlecin maksimum yüksekliği, satır yüksekliğine bağlıdır.",
    ...
    "editContext": "EditContext API'sının, düzenleyicide giriş yapmak için metin alanı yerine kullanılıp kullanılmayacağını belirler.",
    ...
    "editor.find.replaceHistory.never": "Değiştirme pencere öğesinden geçmişi saklama.",
    "editor.find.replaceHistory.workspace": "Etkin çalışma alanındaki değiştirme geçmişini sakla",
    ...
    "editor.inlineSuggest.edits.renderSideBySide.auto": "Daha büyük öneriler, yeterli alan varsa yan yana gösterilir; aksi takdirde aşağıda gösterilir.",
    "editor.inlineSuggest.edits.renderSideBySide.never": "Daha büyük öneriler hiçbir zaman yan yana gösterilmez; her zaman aşağıda gösterilir.",
    ...
    "find.findOnType": "Bulma Aracı'nın siz yazarken arama yapıp yapmayacağını kontrol eder.",
    ...
    "find.replaceHistory": "Pencere öğesi değiştirme geçmişinin nasıl saklanacağını kontrol eder",
    ...
    "inertialScroll": "Kaydırmayı ivmeli hale getir - bu, özellikle Linux'ta dokunmatik yüzey ile kullanışlıdır.",
    ...
    "inlineSuggest.edits.allowCodeShifting": "Bir önerinin gösterilmesinin, satır içi öneriye yer açmak için kodu kaydırıp kaydırmayacağını kontrol eder.",
    "inlineSuggest.edits.renderSideBySide": "Daha büyük önerilerin yan yana gösterilip gösterilmeyeceğini denetler.",
    "inlineSuggest.edits.showCollapsed": "Önerinin, üzerine atlanana kadar daraltılmış olarak gösterip göstereb olmadığını kontrol eder.",
    ...
    "inlineSuggest.minShowDelay": "Yazdıktan sonra satır içi önerilerin gösterileceği en az gecikmeyi milisaniye cinsinden denetler.",
    "inlineSuggest.showOnSuggestConflict": "Öneri çakışması olduğunda satır içi önerilerin gösterilip gösterilmeyeceğini kontrol eder.",
    ...
    "inlineSuggest.suppressInlineSuggestions": "Belirtilen virgülle ayrılmış uzantı kimlikleri için satır içi tamamlamaları bastırır.",
    ...
    "inlineSuggest.triggerCommandOnProviderChange": "Satır içi öneri sağlayıcısı değiştiğinde bir komutun tetiklenip tetiklenmeyeceğini denetler.",
    ...
    "minimap.autohide.mouseover": "Fare mini haritanın üzerinde olmadığında mini harita gizlenir, fare mini haritanın üzerindeyken gösterilir.",
    "minimap.autohide.none": "Mini harita her zaman gösterilmektedir.",
    "minimap.autohide.scroll": "Mini harita yalnızca düzenleyici kaydırıldığında gösterilir.",
    "minimap.enabled": "Mini haritanın gösterilip gösterilmeyeceğini denetler.",
    "minimap.markSectionHeaderRegex": "Açıklamalarda bölüm üst bilgilerini bulmak için kullanılan normal ifadeyi belirtir. Normal ifade, bölüm üst bilgisini kapsüllerken 'label' ('(?<label>.+)' olarak yazılmış) adlandırılmış bir eşleştirme grubu içermeli, aksi takdirde çalışmayacak. İsteğe bağlı olarak 'separator' adlı başka bir eşleşme grubu  dahil edin. Çok \\n üst bilgileri eşleştirmek için desende bir metin kullanın.",
    ...
    "renderRichScreenReaderContent": "`#editor.editContext#` ayarı etkinleştirildiğinde zengin ekran okuyucu içeriğinin işlenip işlenmeyeceğini belirtir.",
    ...
    "scrollOnMiddleClick": "Orta düğmeye basıldığında düzenleyicinin kaydırılıp kaydırılmayacağını denetler.",
    ...
    "selectionHighlightMaxLength": "Benzer eşleşmelerin vurgulanmadığı seçimdeki karakter sayısını kontrol eder. Sınırsız için sıfıra ayarlayın.",
    "selectionHighlightMultiline": "Düzenleyicinin birden çok satıra yayılan seçim eşleşmelerini vurgulayıp vurgulamaması gerektiğini kontrol eder.",
    ...
    "trimWhitespaceOnDelete": "Yeni satır silinirken düzenleyicinin sonraki satırın girinti boşluklarını da silip silmeyeceğini kontrol eder.",
  ...
  "vs/editor/common/languages": {
    ...
    "Variable": "değişken",
    "suggestWidget.kind.class": "Sınıf",
    "suggestWidget.kind.color": "Renk",
    "suggestWidget.kind.constant": "Sabit",
    "suggestWidget.kind.constructor": "Oluşturucu",
    "suggestWidget.kind.customcolor": "Özel Renk",
    "suggestWidget.kind.enum": "Sabit listesi",
    "suggestWidget.kind.enumMember": "Sabit Liste Üyesi",
    "suggestWidget.kind.event": "Olay",
    "suggestWidget.kind.field": "Alan",
    "suggestWidget.kind.file": "Dosya",
    "suggestWidget.kind.folder": "Klasör",
    "suggestWidget.kind.function": "İşlev",
    "suggestWidget.kind.interface": "Arabirim",
    "suggestWidget.kind.issue": "Sorun",
    "suggestWidget.kind.keyword": "Anahtar Sözcük",
    "suggestWidget.kind.method": "Yöntem",
    "suggestWidget.kind.module": "Modül",
    "suggestWidget.kind.operator": "İşleç",
    "suggestWidget.kind.property": "Özellik",
    "suggestWidget.kind.reference": "Başvuru",
    "suggestWidget.kind.snippet": "Kod Parçacığı",
    "suggestWidget.kind.struct": "Yapı",
    "suggestWidget.kind.text": "Metin",
    "suggestWidget.kind.tool": "Araç",
    "suggestWidget.kind.typeParameter": "Tür Parametresi",
    "suggestWidget.kind.unit": "Birim",
    "suggestWidget.kind.user": "Kullanıcı",
    "suggestWidget.kind.value": "Değer",
    "suggestWidget.kind.variable": "Değişken",
    "symbolAriaLabel": "{0} ({1})"
  },
  ...
  "vs/editor/common/standaloneStrings": {
    "acceptSuggestAction": "Şu anda{0} öneriyi kabul etmek için öneriyi kabul edin.",
    ...
    "chatEditing.navigation": "Düzenleyicide önceki{0} ve sonraki{1} seçenekleriyle düzenlemeler arasında gezinin ve mevcut değişiklik için kabul et{2}, reddet{3} veya farkları görüntüle{4} seçeneklerini kullanın. Tüm dosyalardaki düzenlemeleri kabul edin{5}.",
    ...
    "defaultWindowTitleExcludingEditorState": "activeEditorState - (değiştirildi, sorunlar ve daha fazlası), şu anda varsayılan olarak window.title ayarı kapsamında eklenmez. accessibility.windowTitleOptimized ile etkinleştirin.",
    "defaultWindowTitleIncludesEditorState": "activeEditorState - (değiştirildi, sorunlar ve daha fazlası), varsayılan olarak window.title ayarı kapsamında eklenir. accessibility.windowTitleOptimized ile devre dışı bırakın.",
    ...
    "suggestActionsKb": "Olası kod tamamlamalarını{0} için öneri pencere öğesini tetikleyin.",
    ...
    "toggleSuggestionFocus": "Öneri pencere öğesi ile düzenleyici arasındaki odağı{0} ve öneri hakkında daha fazla bilgi edinmek{1} ayrıntılar odağına geçiş yapın.",
    "toolbar": "Çalışma ekranı etrafında, ekran okuyucu bir araç çubuğundan indiğiniz duyurulsa, araç çubuğunun eylemleri arasında gezinmek için dar tuşları kullanın."
  },
  ...
  "vs/editor/contrib/clipboard/browser/clipboard": {
    ...
    "actions.clipboard.copyWithSyntaxHighlightingLabel": "Söz Dizimi Vurgusu ile Kopyala",
  ...
  "vs/editor/contrib/codelens/browser/codelensController": {
    ...
    "showLensOnLine": "Geçerli Satır için CodeLens Komutlarını Göster"
  },
  ...
  "vs/editor/contrib/dropOrPasteInto/browser/copyPasteController": {
    ...
    "resolveProcess": "Uygulama için yapıştırma düzenlemesi '{0}'. İptal etmek için tıklayın"
  },
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/commands": {
    ...
    "action.inlineSuggest.toggleShowCollapsed": "Satır İçi Önerileri Göster Daraltılmış Olarak Değiştir",
    "action.inlineSuggest.trigger": "Satır İçi Öneriyi Tetikle",
    "action.inlineSuggest.trigger.explicitInlineEdit": "Sonraki Düzenleme Önerisini Tetikle",
    "jump": "Atlama",
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/inlineCompletionContextKeys": {
    ...
    "cursorBeforeGhostText": "İmlecin hayalet metinde olup olmadığını kontrol edin",
  ...
  "vs/editor/contrib/linesOperations/browser/linesOperations": {
    ...
    "lines.reverseLines": "Satırları ters çevirin",
  ...
  "vs/editor/contrib/multicursor/browser/multicursor": {
    ...
    "moveSelectionToNextFindMatch": "Son Seçimi Sonraki Bulma Eşleşmesine Taşı",
    "moveSelectionToPreviousFindMatch": "Son Seçimi Önceki Bulma Eşleşmesine Taşı",
  ...
  "vs/editor/contrib/peekView/browser/peekView": {
    ...
    "peekViewEditorStickyScrollGutterBackground": "Gözatma görünümü düzenleyicisindeki yapışkan kaydırmanın cilt payı kısmının arka plan rengi.",
  ...
  "vs/platform/accessibilitySignal/browser/accessibilitySignalService": {
    "accessibility.signals.chatEditModifiedFile": "Dosya Sohbet Düzenlemelerinden Değiştirildi",
    "accessibility.signals.chatRequestSent": "Sohbet İsteği Gönderildi",
    "accessibility.signals.chatUserActionRequired": "Sohbet Kullanıcısı Eylemi Gerekli",
    "accessibility.signals.clear": "Temizle",
    "accessibility.signals.codeActionRequestTriggered": "Kod Eylemi İsteği Tetiklendi",
    "accessibility.signals.editsKept": "Düzenlemeler Korundu",
    "accessibility.signals.editsUndone": "Düzenleme Geri Alındı",
    ...
    "accessibility.signals.nextEditSuggestion": "Sonraki Düzenleme Önerisi",
    ...
    "accessibilitySignals.chatEditModifiedFile": "Sohbet Değiştirilmiş Dosyayı Düzenle",
    ...
    "accessibilitySignals.chatUserActionRequired": "Sohbet Kullanıcısı Eylemi Gerekli",
    ...
    "accessibilitySignals.editsKept": "Düzenlemeler Korundu",
    "accessibilitySignals.editsUndone": "Düzenlemeleri Geri Al",
    ...
    "accessibilitySignals.nextEditSuggestion.name": "Satırda Sonraki Düzenleme Önerisi",
  ...
  "vs/platform/configuration/common/configurationRegistry": {
    ...
    "defaultLanguageConfiguration.description": "{0} için geçersiz kılınacak ayarları yapılandırın.",
  ...
  "vs/platform/contextkey/common/contextkeys": {
    ...
    "isSimulation": "Uygulamanın simülasyon modunda çalışıp çalışmayacağını belirtir.",
  ...
  "vs/platform/markers/common/markers": {
    ...
    "sev.infos": "Bilgiler",
    "sev.warning": "Uyarı",
    "sev.warnings": "Uyarılar"
  },
  "vs/platform/markers/common/markerService": {
    "filtered": "Sorunlar duraklatıldı çünkü: \"{0}\"",
    "filtered.network": "Sorunlar duraklatıldı çünkü: \"{0}\" ve {1} daha fazla"
  },
  "vs/platform/notification/common/notification": {
    "severityPrefix.error": "Hata: {0}",
    "severityPrefix.info": "Bilgi: {0}",
    "severityPrefix.warning": "Uyarı: {0}"
  },
  ...
  "vs/platform/theme/common/colors/editorColors": {
    ...
    "editorStickyScrollGutterBackground": "Düzenleyicideki yapışkan kaydırmanın cilt payı kısmının arka plan rengi",
  ...
  "vs/platform/theme/common/colors/inputColors": {
    ...
    "checkbox.disabled.background": "Devre dışı bırakılmış onay kutusunun arka planı.",
    "checkbox.disabled.foreground": "Devre dışı bırakılmış onay kutusunun ön planı.",
