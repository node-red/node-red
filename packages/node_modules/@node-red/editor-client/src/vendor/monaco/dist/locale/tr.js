...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "Düzenleyicinin yatay kaydırma çubuğuyla yapışkan kaydırma pencere öğesini kaydırmayı etkinleştir.",
    ...
    "hover.hidingDelay": "Üzerinde gezinme gizlendikten sonraki gecikmeyi milisaniye cinsinden kontrol eder. 'editor.hover.sticky' seçeneğinin etkinleştirilmesini gerektirir.",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "Şu anda bir tanılamada değilken satır içinde en yakın hızlı düzeltmeyi göstermeyi etkinleştirin/devre dışı bırakın.",
  ...
  "vs/platform/audioCues/browser/audioCueService": {
    "audioCues.chatRequestSent": "Sohbet İsteği Gönderildi",
    "audioCues.chatResponsePending": "Sohbet Yanıtı Beklemede",
    "audioCues.chatResponseReceived": "Sohbet Yanıtı Alındı",
