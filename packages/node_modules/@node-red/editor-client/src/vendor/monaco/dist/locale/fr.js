...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "inlineEdit.backgroundColoring": "Contrôle s’il faut colorer l’arrière-plan des modifications incluses.",
    "inlineEdit.enabled": "Contrôle s’il faut afficher les modifications incluses dans l’éditeur.",
    "inlineEdit.fontFamily": "Contrôle la famille de polices de la modification incluse.",
    "inlineEdit.showToolbar": "Contrôle quand afficher la barre d’outils d’édition incluse.",
    "inlineEdit.showToolbar.always": "Afficher la barre d’outils de modification incluse chaque fois qu’une suggestion incluse est affichée.",
    "inlineEdit.showToolbar.never": "Ne jamais afficher la barre d’outils de modification incluse.",
    "inlineEdit.showToolbar.onHover": "Afficher la barre d’outils de modification incluse lorsque vous pointez sur une suggestion incluse.",
  ...
  "vs/platform/list/browser/listService": {
    ...
    "sticky scroll maximum items": "Contrôle le nombre d’éléments rémanents affichés dans l’arborescence lorsque « #workbench.tree.enableStickyScroll# » est activé.",
