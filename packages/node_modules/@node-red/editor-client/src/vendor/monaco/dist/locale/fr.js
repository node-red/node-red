...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "Activez le défilement du widget Sticky Scroll avec la barre de défilement horizontale de l'éditeur.",
    ...
    "hover.hidingDelay": "Contrôle le délai en millisecondes, après lequel le pointage est masqué. Demande d'activer 'editor.hover.sticky'.",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "Activez/désactivez l’affichage du correctif rapide le plus proche dans une ligne lorsqu’il n’est pas sur un diagnostic.",
  ...
  "vs/platform/audioCues/browser/audioCueService": {
    "audioCues.chatRequestSent": "Demande de conversation envoyée",
    "audioCues.chatResponsePending": "Réponse de conversation en attente",
    "audioCues.chatResponseReceived": "Réponse de conversation reçue",
