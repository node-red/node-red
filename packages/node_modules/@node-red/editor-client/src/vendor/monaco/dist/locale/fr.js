this.MonacoEnvironment = this.MonacoEnvironment || {}; this.MonacoEnvironment.Locale = {language: 'fr', data: {
    ...
    "vs/editor/common/config/editorOptions": {
        ...
        "inlineHints.enable": "Active les indicateurs inline dans l'éditeur.",
        "inlineHints.fontSize": "Contrôle la taille de police des indicateurs inline dans l'éditeur. Quand la valeur est '0', 90 % de '#editor.fontSize#' est utilisé.",
        "inlineHints.fontFamily": "Contrôle la famille de polices des indicateurs inline dans l'éditeur.",
    ...
    "vs/platform/theme/common/colorRegistry": {
        ...
        "editorInlineHintForeground": "Couleur de premier plan des indicateurs inline",
        "editorInlineHintBackground": "Couleur d'arrière-plan des indicateurs inline",
