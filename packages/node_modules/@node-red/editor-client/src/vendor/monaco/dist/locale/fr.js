...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorConfigurationSchema": {
    ...
    "editor.experimental.preferTreeSitter": "Contrôle si l’analyse de sitter (système) d’arborescence doit être activée pour des langues spécifiques. Cette opération aura priorité sur « editor.experimental.treeSitterTelemetry » pour les langues spécifiées.",
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "colorDecoratorActivatedOn": "Contrôle la condition pour faire apparaître un sélecteur de couleurs à partir d’un élément décoratif de couleurs",
  ...
  "vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorContribution": {
    "defaultProviderDescription": "Configure le fournisseur de dépôt par défaut à utiliser pour le contenu d’un type MIME donné."
  },
