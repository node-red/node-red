...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "Aktiviert das Scrollen des Widgets für den fixierten Bildlauf mit der horizontalen Scrollleiste des Editors.",
  ...
  "vs/editor/common/standaloneStrings": {
    ...
    "stickScrollKb": "Focus Sticky Scroll ({0}) to focus the currently nested scopes.",
    "stickScrollNoKb": "Focus Sticky Scroll to focus the currently nested scopes. It is currently not triggerable by a keybinding.",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "Aktivieren/deaktivieren Sie die Anzeige der nächstgelegenen schnellen Problembehebung innerhalb einer Zeile, wenn derzeit keine Diagnose durchgeführt wird.",
  ...
  "vs/platform/audioCues/browser/audioCueService": {
    "audioCues.chatRequestSent": "Chatanfrage gesendet",
    "audioCues.chatResponsePending": "Chatantwort ausstehend",
    "audioCues.chatResponseReceived": "Chatantwort empfangen",
