...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "minimap.markSectionHeaderRegex": "주석에서 섹션 헤더를 찾는 데 사용되는 정규식을 정의합니다. regex에는 섹션 헤더를 캡슐화하는 명명된 일치 그룹 'label'('(?<label>.+)'으로 작성됨)이 포함되어야 합니다. 그렇지 않으면 작동하지 않습니다. 필요에 따라 'separator'라는 다른 일치 그룹을 포함할 수 있습니다. 패턴에서 \\n 사용하여 여러 줄 머리글을 일치시킬 수 있습니다.",
  ...
  "vs/editor/common/standaloneStrings": {
    ...
    "suggestActionsKb": "코드 완성을 표시하려면 제안 위젯{0} 트리거합니다.",
  ...
  "vs/editor/contrib/inlineCompletions/browser/controller/commands": {
    ...
    "action.inlineSuggest.trigger.explicitInlineEdit": "다음 편집 제안 트리거",
    "jump": "점프",
    "noInlineEditAvailable": "인라인 편집을 사용할 수 없습니다.",
    "reject": "Reject"
  },
  ...
  "vs/platform/contextkey/common/contextkeys": {
    ...
    "isSimulation": "애플리케이션이 시뮬레이션 모드에서 실행되는지 확인합니다.",
