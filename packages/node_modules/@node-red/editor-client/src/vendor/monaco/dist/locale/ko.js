...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "편집기의 가로 스크롤 막대를 사용하여 고정 스크롤 위젯의 스크롤을 사용하도록 설정합니다.",
    ...
    "hover.hidingDelay": "가리키기가 숨겨지는 지연 시간(밀리초)을 제어합니다. 'editor.hover.sticky'를 사용하도록 설정해야 합니다.",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "현재 진단 중이 아닐 때 줄 내에서 가장 가까운 빠른 접두사 표시를 사용/사용 안 함으로 설정합니다.",
