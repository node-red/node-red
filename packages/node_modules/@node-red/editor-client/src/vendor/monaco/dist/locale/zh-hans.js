...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorConfigurationSchema": {
    ...
    "editor.experimental.preferTreeSitter.css": "控制是否应为 css 启用 Tree Sitter 分析。对于 css，此操作将优先于 `#editor.experimental.treeSitterTelemetry#`。",
    "editor.experimental.preferTreeSitter.ini": "控制是否应为 ini 启用 tree sitter 分析。对于 ini，此操作将优先于 `#editor.experimental.treeSitterTelemetry#`。",
    "editor.experimental.preferTreeSitter.regex": "控制是否应为正则表达式启用 tree sitter 分析。对于正则表达式，此操作将优先于 `#editor.experimental.treeSitterTelemetry#`。",
    "editor.experimental.preferTreeSitter.typescript": "控制是否应为 Typescript 启用 tree sitter 分析。对于 Typescript，此操作将优先于 `#editor.experimental.treeSitterTelemetry#`。",
    "editor.experimental.treeSitterTelemetry": "控制是否应启用树 sitter 分析和收集遥测数据。设置 `#editor.experimental.preferTreeSitter#` 以优先使用特定语言。",
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "allowVariableFonts": "控制是否允许在编辑器中使用可变字体。",
    "allowVariableFontsInAccessibilityMode": "控制是否允许在辅助功能模式下在编辑器中使用可变字体。",
    "allowVariableLineHeights": "控制是否允许在编辑器中使用可变行高。",
    ...
    "autoIndentOnPaste": "控制编辑器是否应自动缩进粘贴的内容。",
    "autoIndentOnPasteWithinString": "控制编辑器是否应在粘贴到字符串中时自动缩进粘贴的内容。当 autoIndentOnPaste 为 true 时，此操作将会生效。",
    ...
    "cursorHeight": "当 `#editor.cursorStyle#` 设置为 `line` 时，控制光标的高度。光标的最大高度取决于行高。",
    ...
    "editContext": "设置是否应使用 EditContext API 而不是文本区域来支持在编辑器中输入。",
    ...
    "editor.defaultColorDecorators.always": "始终显示默认颜色修饰器。",
    "editor.defaultColorDecorators.auto": "仅当没有扩展提供颜色修饰器时才显示默认颜色修饰器。",
    "editor.defaultColorDecorators.never": "从不显示默认颜色修饰器。",
    ...
    "editor.find.history.never": "不要存储查找小组件中的搜索历史记录。",
    "editor.find.history.workspace": "跨活动工作区存储搜索历史记录",
    "editor.find.replaceHistory.never": "不要存储替换小组件的历史记录。",
    "editor.find.replaceHistory.workspace": "跨活动工作区存储替换历史记录",
    ...
    "editor.inlineSuggest.edits.renderSideBySide.auto": "如果有足够的空间，较大的建议将并排显示，否则将显示在下面。",
    "editor.inlineSuggest.edits.renderSideBySide.never": "较大的建议从不并排显示，而是始终显示在下面。",
    ...
    "experimentalGpuAcceleration": "控制是否使用实验性 GPU 加速来呈现编辑器。",
    "experimentalGpuAcceleration.off": "使用基于 DOM 的常规呈现。",
    ...
    "find.findOnType": "控制在键入时是否应搜索“查找”小组件。",
    "find.globalFindClipboard": "控制“查找”小组件是否读取或修改 macOS 的共享查找剪贴板。",
    "find.history": "控制如何存储查找小组件历史记录",
    "find.loop": "控制在找不到其他匹配项时，是否自动从开头(或结尾)重新开始搜索。",
    "find.replaceHistory": "控制如何存储替换小组件历史记录",
    ...
    "hover.hidingDelay": "控制隐藏悬停提示前的延迟时间(毫秒)。需要启用 `#editor.hover.sticky#`。",
    "hover.sticky": "控制当鼠标移动到悬停提示上时，其是否保持可见。",
    "inertialScroll": "为滚动设置惯性 - 最适合用于 Linux 上的触摸板。",
    ...
    "inlineSuggest.edits.allowCodeShifting": "控制显示建议是否会移动代码，以便为内联建议留出空间。",
    "inlineSuggest.edits.renderSideBySide": "控制是否可以并排显示较大的建议。",
    "inlineSuggest.edits.showCollapsed": "控制在跳到建议之前，建议是否显示为折叠。",
    "inlineSuggest.enabled": "控制是否在编辑器中自动显示内联建议。",
    "inlineSuggest.fontFamily": "控制内联建议的字体系列。",
    "inlineSuggest.minShowDelay": "控制键入后显示内联建议前的最小延迟(以毫秒为单位)。",
    "inlineSuggest.showOnSuggestConflict": "控制是否在存在建议冲突时显示内联建议。",
    ...
    "inlineSuggest.suppressInlineSuggestions": "抑制指定扩展 ID (以逗号分隔)的内联补全功能。",
    ...
    "inlineSuggest.triggerCommandOnProviderChange": "控制内联建议提供程序更改时是否触发命令。",
    ...
    "minimap.autohide.mouseover": "鼠标不在缩略图上时隐藏缩略图，鼠标在缩略图上时显示缩略图。",
    "minimap.autohide.none": "缩略图始终显示。",
    "minimap.autohide.scroll": "仅在滚动编辑器时显示缩略图",
    "minimap.enabled": "控制是否显示缩略图。",
    "minimap.markSectionHeaderRegex": "定义用于在注释中查找节标头的正则表达式。正则表达式必须包含命名匹配组“label”，(写为 “(？<label>.+)”) 封装节标头，否则它将不起作用。可以选择包括另一个名为“separator”的匹配组。使用模式中的 \\n 匹配多行标头。",
    ...
    "occurrencesHighlightDelay": "控制突出显示出现次数前的等待时间(以毫秒为单位)。",
    "off": "已禁用快速建议",
    "on": "快速建议显示在建议小组件内",
    "overtypeCursorStyle": "在改写输入模式中控制光标样式。",
    "overtypeOnPaste": "控制粘贴是否改写。",
    ...
    "renderRichScreenReaderContent": "启用 `#editor.editContext#` 设置时是否呈现丰富的屏幕阅读器内容。",
    ...
    "scrollOnMiddleClick": "控制在按下中间按钮时编辑器是否滚动。",
    ...
    "selectionHighlightMaxLength": "控制在不突出显示类似匹配项之前，可以选择的字符数。设置为零表示无限制。",
    "selectionHighlightMultiline": "控制编辑器是否应突出显示跨多行的选择匹配项。",
    ...
    "trimWhitespaceOnDelete": "控制在删除新行时编辑器是否还会删除下一行的缩进空格。",
    ...
    "wrapOnEscapedLineFeeds": "控制在启用 `#editor.wordWrap#` 时文本 `\\n` 是否应触发 wordWrap。\r\n\r\n例如:\r\n```c\r\nchar* str=\"hello\\nworld\"\r\n```\r\n将显示为\r\n```c\r\nchar* str=\"hello\\n\r\n           world\"\r\n```",
  ...
  "vs/editor/common/languages": {
    ...
    "TypeParameter": "类型参数",
    "Variable": "变量",
    "suggestWidget.kind.class": "类",
    "suggestWidget.kind.color": "颜色",
    "suggestWidget.kind.constant": "常数",
    "suggestWidget.kind.constructor": "构造函数",
    "suggestWidget.kind.customcolor": "自定义颜色",
    "suggestWidget.kind.enum": "枚举",
    "suggestWidget.kind.enumMember": "枚举成员",
    "suggestWidget.kind.event": "事件",
    "suggestWidget.kind.field": "字段",
    "suggestWidget.kind.file": "文件",
    "suggestWidget.kind.folder": "文件夹",
    "suggestWidget.kind.function": "函数",
    "suggestWidget.kind.interface": "接口",
    "suggestWidget.kind.issue": "问题",
    "suggestWidget.kind.keyword": "关键字",
    "suggestWidget.kind.method": "方法",
    "suggestWidget.kind.module": "模块",
    "suggestWidget.kind.operator": "运算符",
    "suggestWidget.kind.property": "属性",
    "suggestWidget.kind.reference": "参考",
    "suggestWidget.kind.snippet": "片段",
    "suggestWidget.kind.struct": "结构",
    "suggestWidget.kind.text": "文本",
    "suggestWidget.kind.tool": "工具",
    "suggestWidget.kind.typeParameter": "类型参数",
    "suggestWidget.kind.unit": "单位",
    "suggestWidget.kind.user": "用户",
    "suggestWidget.kind.value": "值",
    "suggestWidget.kind.variable": "变量",
    "symbolAriaLabel": "{0} ({1})"
  },
  ...
  "vs/editor/common/standaloneStrings": {
    "acceptSuggestAction": "接受建议{0} 接受当前选定的建议。",
    ...
    "chatEditing.navigation": "在编辑器中的编辑之间导航，可导航上一个{0} 和下一个{1}、接受{2}、拒绝{3} 或查看当前更改的差异{4}。接受所有文件中的编辑{5}。",
    "chatEditorModification": "编辑器包含聊天所做的挂起的修改。",
    "chatEditorRequestInProgress": "编辑器当前正在等待聊天进行修改。",
    ...
    "defaultWindowTitleExcludingEditorState": "默认情况下，activeEditorState (如修改的、问题等)不作为 window.title 设置的一部分包含在内。使用 accessibility.windowTitleOptimized 启用它。",
    "defaultWindowTitleIncludesEditorState": "默认情况下，activeEditorState (如修改、问题等)作为 window.title 设置的一部分包含在内。使用 accessibility.windowTitleOptimized 禁用它。",
    ...
    "suggestActionsKb": "触发建议小组件{0} 以显示可能的代码完成。",
    ...
    "toggleSuggestionFocus": "在建议小组件和编辑器{0} 之间切换焦点，并使用{1} 切换详细信息焦点以了解有关建议的详细信息。",
    "toolbar": "在工作台周围，当屏幕阅读器宣布你已登录到工具栏时，使用窄键在工具栏的作之间导航。"
  },
  ...
  "vs/editor/contrib/codeAction/browser/codeActionCommands": {
    ...
    "organizeImports.description": "组织当前文件中的导入。也被一些工作称为“优化导入”",
  ...
  "vs/editor/contrib/indentation/browser/indentation": {
    ...
    "currentTabSize": "当前制表符大小",
    "defaultTabSize": "默认制表符大小",
  ...
  "vs/editor/contrib/peekView/browser/peekView": {
    ...
    "peekViewEditorStickyScrollGutterBackground": "速览视图编辑器中粘滞滚动的装订线部件的背景色。",
  ...
  "vs/editor/contrib/stickyScroll/browser/stickyScrollActions": {
    ...
    "mifocusEditorStickyScroll": "焦点编辑器粘滞滚动(&&F)",
  ...
  "vs/editor/contrib/suggest/browser/wordContextKey": {
    "desc": "在单词结尾时为 true 的上下文键。请注意，仅在启用制表符完成时才定义此项"
  },
  ...
  "vs/platform/accessibilitySignal/browser/accessibilitySignalService": {
    "accessibility.signals.chatEditModifiedFile": "从聊天编辑修改的文件",
    "accessibility.signals.chatRequestSent": "已发送聊天请求",
    "accessibility.signals.chatUserActionRequired": "需要聊天用户操作",
    "accessibility.signals.clear": "清除",
    "accessibility.signals.codeActionRequestTriggered": "已触发代码操作请求",
    "accessibility.signals.editsKept": "已保留编辑",
    "accessibility.signals.editsUndone": "已撤消编辑",
    ...
    "accessibility.signals.nextEditSuggestion": "下一个编辑建议",
    ...
    "accessibilitySignals.chatEditModifiedFile": "聊天编辑修改的文件",
    "accessibilitySignals.chatRequestSent": "已发送聊天请求",
    "accessibilitySignals.chatResponseReceived": "已收到聊天响应",
    "accessibilitySignals.chatUserActionRequired": "需要聊天用户操作",
    "accessibilitySignals.clear": "清除",
    "accessibilitySignals.codeActionApplied": "已应用代码操作",
    "accessibilitySignals.codeActionRequestTriggered": "已触发代码操作请求",
    ...
    "accessibilitySignals.editsKept": "已保留编辑",
    "accessibilitySignals.editsUndone": "撤消编辑",
    ...
    "accessibilitySignals.nextEditSuggestion.name": "行上的下一个编辑建议",
  ...
  "vs/platform/configuration/common/configurationRegistry": {
    ...
    "defaultLanguageConfiguration.description": "配置要为 {0} 替代的设置。",
  ...
  "vs/platform/list/browser/listService": {
    ...
    "sticky scroll maximum items": "控制启用 {0} 时树中显示的粘滞元素数。",
  ...
  "vs/platform/markers/common/markerService": {
    "filtered": "问题已暂停，因为:“{0}”",
    "filtered.network": "问题已暂停，因为:“{0}”和 {1} 等"
  },
  "vs/platform/notification/common/notification": {
    "severityPrefix.error": "错误: {0}",
    "severityPrefix.info": "信息: {0}",
  ...
  "vs/platform/quickinput/browser/quickInput": {
    ...
    "quickInputAlignment": "快速输入项的对齐方式",
  ...
  "vs/platform/theme/common/colors/editorColors": {
    ...
    "editorCompositionBorder": "输入法组合的边框颜色。",
    ...
    "editorStickyScrollGutterBackground": "编辑器中粘滞滚动的装订线部件的背景色",
  ...
  "vs/platform/theme/common/colors/inputColors": {
    ...
    "checkbox.disabled.background": "变暗的复选框的背景。",
    "checkbox.disabled.foreground": "变暗的复选框的前景。",
  ...
  "vs/platform/theme/common/iconRegistry": {
    ...
    "schema.fontId.formatError": "字体 ID 只能包含字母、数字、下划线和短划线。",
