...
window.MonacoEnvironment.Locale = window.MonacoLocale = {
  ...
  "vs/editor/common/config/editorOptions": {
    ...
    "editor.stickyScroll.scrollWithEditor": "使用编辑器的水平滚动条启用粘滞滚动小组件滚动。",
    ...
    "hover.hidingDelay": "控制隐藏悬停后的延迟时间(毫秒)。需要启用 `editor.hover.sticky`。",
  ...
  "vs/editor/contrib/codeAction/browser/codeActionContributions": {
    "includeNearbyQuickfixes": "启用/禁用在当前未进行诊断时显示行内最近的快速配置。",
