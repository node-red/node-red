...
RED.keyboard = (function() {
    ...
    function editShortcut(e) {
        ...
        if (!container.hasClass('keyboard-shortcut-entry-expanded')) {
            ...
            var okButton = $('<button class="red-ui-button red-ui-button-small"><i class="fa fa-check"></i></button>').attr('aria-label', RED._('common.label.ok')).appendTo(div);
            var revertButton = $('<button class="red-ui-button red-ui-button-small"><i class="fa fa-reply"></i></button>').attr('aria-label', RED._('keyboard.revertEdit')).appendTo(div);
