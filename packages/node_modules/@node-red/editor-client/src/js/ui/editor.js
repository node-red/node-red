...
RED.editor = (function() {
            ...
            .editableList({
                addItem: function (container0, i, opt) {
                    ...
                    var valueField = $("<input/>", {
                        class: "params-value",
                        type: "text",
                        style: "width: 67%; margin-left:5px"
                    }).appendTo(row1)
                        .typedInput({
                            default: type,
                            types: [
    ...
    function convUISetting(con) {
        var params = [];
        var list = con.editableList("items");
    ...
    function loadParams(container, params) {
        ...
        if (params) {
            var rules = container.editableList("items");
    ...
    function buildUiEditForm(container, node) {
        var dialogForm = $('<form class="dialog-form form-horizontal" autocomplete="off"></form>').appendTo(container);
        ...
        button_preview.click(function(e) {
            var ui_def_list = convUISetting(edit_con);
    ...
    function buildUiPreviewForm(container,node) {
        var dialogForm = $('<form class="dialog-form form-horizontal" autocomplete="off"></form>').appendTo(container);
        $('<div class="form-row">'+
          '  UI Preview'+
          '</div>').appendTo(dialogForm);
        ...
        var trayOptions = {
                ...
                },
                {
                    ...
                    click: function() {
                        ...
                        if (type === "subflow") {
                            ...
                            var new_ui = convUISetting($("#ui-edit-container"));
            ...
            open: function(tray, done) {
                ...
                if (type === "subflow") {
                    ...
                    buildUiEditForm(uiEditTab.content, node);
                    editorTabs.addTab(uiEditTab);

                    var uiPreviewTab = {
                        id: "editor-tab-ui-preview",
                        label: RED._("editor-tab.ui-preview"),
                        name: RED._("editor-tab.ui-preview"),
                        content: $('<div>', {class:"editor-tray-content"}).appendTo(editorContent).hide(),
                    ...
                    buildUiPreviewForm(uiPreviewTab.content,node);
                    editorTabs.addTab(uiPreviewTab);
                }
