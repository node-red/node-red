...
RED.editor = (function() {
    ...
    function getEditorSettings() {
        ...
        //console.log("getEditorSettings - RED.settings.editor is empty. Defaulting to ACE"); //TODO: remove
        return {
            lib: "ACE",
            theme: "",
            options: {}
    ...
    function initMonaco() {
        ...
        function createJSSnippets(range) {
            return [
                ...
                createMonacoSnippet("get (node context)", 'context.get("${1:name}");','Get a value from node context',range),
                createMonacoSnippet("set (node context)", 'context.set("${1:name}", ${1:value});','Set a value in node context',range),
                createMonacoSnippet("get (flow context)", 'flow.get("${1:name}");','Get a value from flow context',range),
                createMonacoSnippet("set (flow context)", 'flow.set("${1:name}", ${1:value});','Set a value in flow context',range),
                createMonacoSnippet("get (global context)", 'global .get("${1:name}");','Get a value from global context',range),
                createMonacoSnippet("set (global context)", 'global .set("${1:name}", ${1:value});','Set a value in global context',range),
    ...
    return {
        init: function() {
            ...
            console.log("packages/node_modules/@node-red/editor-client/src/js/ui/editor.js ➡ init()")
            initEditor();
        },
        edit: showEditDialog,
