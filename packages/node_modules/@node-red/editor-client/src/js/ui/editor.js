...
RED.editor = (function() {
            ...
            provideCompletionItems: function(model, position) {
                ...
                var jsonataSuggestions = jsonataFunctions.map(function (f) {
                    ...
                    return {
                        ...
                        "insertText": jsonata.getFunctionSnippet(f),
    ...
    function initMonaco(){
        ...
        function createDependencyProposals(range) {
            return [        
                monacoSnippet("forloop (for loop)", 'for (let ${1:index} = 0; ${1:index} < ${2:array}.length; ${1:index}++) {\n\tconst element = ${2:array}[${1:index}];\n\t${3}\n}','for loop',range),
                monacoSnippet("foreach (for Each)", '${1:myArray}.forEach(function(${2:elem}) {\n\t${3}\n});','forEach',range),
                monacoSnippet("forin (for in)", 'for (${1:prop} in ${2:obj}) {\n\tif (${2:obj}.hasOwnProperty(${1:prop})) {\n\t\t${3}\n\t}\n}','for in',range),
                monacoSnippet("func (function)", 'function ${1:methodName}(${2:arguments}) {\n\t${3}\n}','function',range),
                monacoSnippet("funca (anonymous function)", 'var ${1:fn} = function(${2:arguments}) {\n\t${3}\n}','anonymous function',range),
                ...
                monacoSnippet("jp (JSON.parse)", 'JSON.parse(${1:obj});','JSON.parse',range),
                monacoSnippet("js (JSON.stringify)", 'JSON.stringify(${1:obj});','JSON.stringify',range),
                monacoSnippet("si (setInterval)", 'setInterval(function() {\n\t${2}\n}, ${1:delay});','setInterval',range),
                monacoSnippet("st (setTimeout)", 'setTimeout(function() {\n\t${2}\n}, ${1:delay});','setTimeout',range),
                monacoSnippet("ase (assert.equal)", 'assert.equal(${1:actual}, ${2:expected});','assert.equal',range),
                monacoSnippet("asd (assert.deepEqual)", 'assert.deepEqual(${1:actual}, ${2:expected});','assert.deepEqual',range),
                monacoSnippet("asn (assert.notEqual)", 'assert.notEqual(${1:actual}, ${2:expected});','assert.notEqual',range),
                {
                ...
                {
                    label: 'cloneMessage (RED.util)',
                    kind: monaco.languages.CompletionItemKind.Snippet,
                    documentation: { value: "`RED.util.cloneMessage(msg: object): any;`\n\n---\n\nClone a msg object" },
                    insertText: 'RED.util.cloneMessage(${1:msg});',
                    insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                    range: range
                },
                {
                    label: 'getObjectProperty (RED.util)',
                    kind: monaco.languages.CompletionItemKind.Snippet,
                    documentation: { 
                        value: 
                            "RED.util.getObjectProperty(msg: object, prop: string): any;\n\n" + 
                            "Gets a property of an object\n\n" + 
                            "*@param* `msg` — the msg object\n\n" +
                            "*@param* `prop` — the msg object"
                    },
                    insertText: 'RED.util.getObjectProperty(${1:msg},${2:prop});',
                    insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                    range: range
                },
                {
                    label: 'setObjectProperty (RED.util)',
                    kind: monaco.languages.CompletionItemKind.Snippet,
                    documentation: { 
                        value: 
                            ...
                            "*@param* `msg` — the msg object\n" +
                            "*@param* `prop` — the msg object\n" +
                            "*@param* `value` — the msg object\n" +
                            "*@param* `createMissing` — the msg object"
                    },
                    insertText: 'RED.util.setObjectProperty(${1:msg},${2:prop},${3:value},${4:createMissing});',
                    insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                    range: range
                },
                {
                    label: 'getMessageProperty (RED.util)',
                    kind: monaco.languages.CompletionItemKind.Snippet,
                    documentation: { 
                        value: 
                            "RED.util.getObjectProperty(msg: object, prop: string): any;\n\n" + 
                    ...
                    insertText: 'RED.util.getMessageProperty(${1:msg},${2:prop});',
                    insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                    range: range
                },
                {
                    label: 'setMessageProperty (RED.util)',
                    kind: monaco.languages.CompletionItemKind.Snippet,
                    documentation:  { 
                        value: 
                    ...
                    insertText: 'RED.util.setMessageProperty(${1:msg},${2:prop},${3:value},${4:createMissing});',
                    insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
                    range: range
                }
            ];
