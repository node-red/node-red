...
RED.editor = (function() {
        ...
        function setupJS(_monaco, _monacoSettings) {
            ...
            var createJSSnippets = function(range) {
                return [
                    ...
                    createMonacoSnippet("node.log", 'node.log(${1:"info"});','Write an info message to the console (not sent to sidebar)',range),
                    createMonacoSnippet("node.warn", 'node.warn(${1:"my warning"});','Write a warning to the console and debug sidebar',range),
                    createMonacoSnippet("node.error", 'node.error(${1:"my error message"}, ${2:msg});','Send an error to the console and debug sidebar. To trigger a Catch node on the same tab, the function should call `node.error` with the original message as a second argument',range),
    ...
    function createMonacoEditor(options) {
        ...
        if(browser.mobile || browser.tablet) {
            ...
            if(!editorOptions.accessibilitySupport &&  browser.android) editorOptions.accessibilitySupport = "off"; //ref https://github.com/microsoft/pxt/pull/7099/commits/35fd3e969b0d5b68ca1e35809f96cea81ef243bc
        }
        //#endregion
