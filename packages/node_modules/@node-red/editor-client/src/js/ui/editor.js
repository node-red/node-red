...
RED.editor = (function() {
    ...
    function buildInputUI(container, params, map) {
        container.empty();
        if (!params) {
            return;
        }
    ...
    function exportUISetting(list) {
        ...
        list.each(function (i, item) {
            ...
            var label = entry.find(".params-label").val();
    ...
    function buildUiEditForm(container, input_con, node) {
        ...
        if (input_con) {
            ...
            button_apply.click(function(e) {
                ...
                buildInputUI(input_con, ui_def_list, ui_in_tmp);
            });
        }
        ...
        button_preview.click(function(e) {
            e.preventDefault();
            var ui_def_list = exportUISetting(edit_con.editableList("items"));
            buildInputUI(preview_con, ui_def_list, {});
            ui_edit.hide();
            ui_preview.show();
        });
