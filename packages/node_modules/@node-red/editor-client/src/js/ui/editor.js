...
RED.editor = (function() {
    ...
    function initMonaco(){
        ...
        */
        ...
        var redUtilURL = "./vendor/monaco/dist/node-red-extra.d.ts"
        var redTS, redUtilUri = '@types/node-red/node-red-extra.util.d.ts';
        debugger
        makeRequest('GET', redUtilURL).then(function(data){
            redTS = data;
            monaco.languages.typescript.typescriptDefaults.addExtraLib(redTS, redUtilUri);
            monaco.languages.typescript.javascriptDefaults.addExtraLib(redTS, redUtilUri);
        });
