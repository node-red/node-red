    ...
    function initMonaco(){
        ...
        function createDependencyProposals(range) {
            return [        
                ...
                monacoSnippet("fn (function)", 'function ${1:methodName}(${2:arguments}) {\n\t${3}\n}','function',range),
                monacoSnippet("afn (anonymous function)", 'var ${1:fn} = function(${2:arguments}) {\n\t${3}\n}','anonymous function',range),
                monacoSnippet("pr (prototype)", '${1:ClassName}.prototype.${2:methodName} = function(${3:arguments}) {\n\t${4}\n}','prototype',range),
