...
RED.editor = (function() {
    ...
    function initEditor(){
        try {
            ...
            var USE_MONACO = editorSettings.lib === "MONACO" || false;
            if(USE_MONACO) {
                initMonaco();
                this.createEditor = createMonacoEditor;
            } else {
                this.createEditor = createACEEditor;
            }
        } catch (error) {
            this.createEditor = createACEEditor;//failsafe
            console.error("Problem editor settings", error);
        }       
    }
    ...
    function initMonaco(){
        if(!require){
            console.warn("require is null - cannot initialise MONACO");
            return;
        }
    ...
    function createMonacoEditor(options) {
        ...
        var defTheme = editorSettings.theme || "vs-dark";
           
        var fixMode = function(mode) {
        ...
        if (options.options) {
            ...
            opts.enableSnippets = true ////https://microsoft.github.io/monaco-editor/api/interfaces/monaco.editor.istandaloneeditorconstructionoptions.html#snippetsuggestions
        }
        if(options.theme){
            opts.theme = options.theme
        } else {
            opts.theme = defTheme || 'vs-dark';
        }
        console.log("monaco opts.theme = ", opts.theme)
        if (options.foldStyle) {
            switch (options.foldStyle) {
                case "none":
                    opts.foldStyle = false;
                    opts.foldingHighlight = false
                    break;
                default:
                    opts.foldStyle = true;
                    opts.foldingHighlight = true;
                    break;
            }
        } else {
            opts.foldStyle = true;
        ...
        opts.mode = fixMode(options.mode);
        ...
        var ed = monaco.editor.create(el, {
            ...
            folding: opts.foldStyle, //https://microsoft.github.io/monaco-editor/api/interfaces/monaco.editor.istandaloneeditorconstructionoptions.html#folding
            foldingHighlight: opts.foldingHighlight, 
            //enableBasicAutocompletion:true, 
            snippetSuggestions: opts.enableSnippets, //https://microsoft.github.io/monaco-editor/api/interfaces/monaco.editor.istandaloneeditorconstructionoptions.html#snippetsuggestions
        ...
        console.log("returning editor instance for " + opts.mode)
        return ed;
