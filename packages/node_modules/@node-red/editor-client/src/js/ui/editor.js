...
RED.editor = (function() {
    ...
    function buildEnvControl(controlCon, envCon) {
        ...
        $("<label/>").text(RED._("editor.locale")).appendTo(row0);
        ...
        var buttonCon0 = $("<div/>").css({
            float: "right"
        }).appendTo(row0);
        var previewButton = $('<button/>').css({
        }).button().text(RED._("editor.previewUI")).appendTo(buttonCon0);

        var buttonCon1 = $("<div/>").css({
            float: "right"
        }).appendTo(row1);
        var okButton = $('<button/>').css({
        }).button().text(RED._("editor.previewOK")).appendTo(buttonCon1);
