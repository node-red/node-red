...
RED.editor = (function() {
    ...
    function buildUiEditForm(container,node) {
        var dialogForm = $('<form class="dialog-form form-horizontal" autocomplete="off"></form>').appendTo(container);
        $('<div>'+
          '    <div class="node-row-ui-edit">'+
          '        <div class="form-row ui-edit-container-row">'+
          '            <ol id="ui-edit-container"></ol>'+
          '        </div>'+
          '    </div>'+
          '</div>').appendTo(dialogForm);
        var height = $(window).height() -280;
        var edit_con = $("#ui-edit-container");
