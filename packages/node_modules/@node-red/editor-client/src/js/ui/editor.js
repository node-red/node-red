...
RED.editor = (function() {
    ...
    function initMonaco() {
        ...
        $.get(monaco.__nodered_extraLib_URL, function (data) {
            console.log("initMonaco --> setupJS --> $.get --> data");
    ...
    function createMonacoEditor(options) {
        ...
        //if clientSideSuggestions is not supplied, check see if requested mode is "nrjavascript"
        ...
        if (serverSideSuggestions) {
            console.log("createMonacoEditor --> setup editor serverside js suggestions");
            ...
            console.log("createMonacoEditor --> setup editor clientside js suggestions");
