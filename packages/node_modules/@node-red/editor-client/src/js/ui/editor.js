...
RED.editor = (function() {
    ...
    function isSameUI(ui0, ui1) {
        var s0 = JSON.stringify(ui0);
        var s1 = JSON.stringify(ui1);
        return (s0 === s1);
    }
    ...
    function buildInputUI(container, params) {
        container.empty();
    ...
    function exportUISetting(list) {
        ...
        list.each(function (i, item) {
            var name = $(item).find(".params-name").val();
            var target = $(item).find(".params-target").val();
    ...
    function buildUiEditForm(container, input_con, node) {
        ...
        button_apply.click(function(e) {
            ...
            buildInputUI(input_con, ui_def_list);
        });
        ...
        //console.log("; LEN: ", edit_con.editableList("length"));
        //console.log("; ITM: ", edit_con.editableList("items"));
        //var ui_def_list = exportUISetting(edit_con.editableList("items"));
        //console.log("; UIDL: ", ui_def_list);
        //buildInputUI(input_con, ui_def_list);

    } // buildUiEditForm

    function buildUiInputForm(container, node) {
        var dialogForm = $('<form class="dialog-form form-horizontal" autocomplete="off"></form>').appendTo(container);
        var div = $("<div>", {
            class: "form-row"
        }).appendTo(dialogForm);
        ...
        var trayOptions = {
            ...
            open: function(tray, done) {
                ...
                if (type === "subflow") {
                    ...
                    var input_con = buildUiInputForm(uiInputTab.content, node);
