        ...
        for (var i = 0; i < tenvs.length; i++) {
            ...
            if (ui && ui.hasUI) { 
                ...
                if (type === "checkbox") {
                    ...
                    if (envCon) {
                        valueField.prop("checked", (ienv.value === "true"));
                    ...
                    if (type === "input") {
                        ...
                        if (envCon) {
                            valueField.typedInput("type", ienv.type);
                            valueField.typedInput("value", ienv.value);
                            valueField.change(
                                (function (pos, field) {
                                    return function (v, t) {
                        ...
                        if (envCon) {
                            if (ienv.value && (ienv.value !== "")) {
                                selector.val(ienv.value);
                            }
                            else if(initVal) {
                        ...
                        if (envCon) {
                            if (ienv.value && (ienv.value !== "")) {
                                valueField.spinner("value", ienv.value);
                            }
                            valueField.spinner({
