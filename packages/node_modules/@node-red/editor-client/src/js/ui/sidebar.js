...
RED.sidebar = (function() {
    ...
    const sidebars = {
        primary: {
            id: 'primary',
            direction: 'right',
            menuToggle: 'menu-item-right-sidebar',
            minimumWidth: 180,
            maximumWidth: 800,
            defaultWidth: 300,
        ...
        secondary: {
            id: 'secondary',
            direction: 'left',
            menuToggle: 'menu-item-left-sidebar',
            minimumWidth: 180,
            maximumWidth: 800,
    ...
    function addTab(title,content,closeable,visible) {
        ...
        options.tabButton = $('<button></button>').attr('aria-label', options.name || options.id)
    ...
    function setupSidebarTabs() {
        ...
        const groupContainer = $('<div></div>').css({display: 'flex'}).appendTo(tabBar);
        globalTabBar.containers = {
            secondary: {
                top: $('<span class="button-group"></span>').appendTo(groupContainer),
                bottom: $('<span class="button-group"></span>').appendTo(groupContainer)
            },
            primary: {
                top: $('<span class="button-group"></span>').appendTo(groupContainer),
                bottom: $('<span class="button-group"></span>').appendTo(groupContainer)
        ...
        const tabBarTools = $('<span class="button-group red-ui-sidebar-tab-bar-tools"></span>').appendTo(groupContainer);
        ...
        const leftToggleButton = $('<button class="red-ui-sidebar-toggle-button red-ui-sidebar-toggle-button-left"></button>').attr('aria-label', RED._('keyboard.toggleLeftSidebar'))
        ...
        RED.popover.tooltip(leftToggleButton, RED._('keyboard.toggleLeftSidebar'), 'core:toggle-left-sidebar');
        leftToggleButton.appendTo(tabBarTools);
        sidebars.secondary.toggleButton = leftToggleButton;

        const rightToggleButton = $('<button class="red-ui-sidebar-toggle-button red-ui-sidebar-toggle-button-right"></button>').attr('aria-label', RED._('keyboard.toggleSidebar'))
        ...
        RED.popover.tooltip(rightToggleButton, RED._('keyboard.toggleSidebar'), 'core:toggle-right-sidebar');
    ...
    function init () {
        ...
        RED.actions.add("core:toggle-sidebar", function(state) {
            RED.actions.invoke("core:toggle-right-sidebar", state)
        })
        RED.actions.add("core:toggle-right-sidebar",function(state){
            if (state === undefined) {
                RED.menu.toggleSelected(sidebars.primary.menuToggle);
            } else {
        ...
        RED.actions.add("core:toggle-palette",function(state){
            RED.actions.invoke("core:toggle-left-sidebar", state)
        })
        RED.actions.add("core:toggle-left-sidebar",function(state){
            if (state === undefined) {
                RED.menu.toggleSelected(sidebars.secondary.menuToggle);
            } else {
