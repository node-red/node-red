...
RED.sidebar = (function() {
    ...
    function setupSidebarTabButtonContainer(sidebar, position) {
    ...
    function setupSidebarTabs(sidebar) {
        ...
        tabBarButtonsContainer.attr('id', sidebar.container.attr('id') + '-tab-bar')
        ...
        sidebar.resizeSidebarTabBar  = function () {
            ...
            if (tabBarButtonsBottom < bottomButton.position().top + buttonHeight * 1.5) {
                ...
                if (hiddenChildren.length > 0) {
                    ...
                    if (hiddenChildren.length - shownCount <= 1) {
        ...
        $(window).on("resize", sidebar.resizeSidebarTabBar)
        return tabBarButtonsContainer
    }
