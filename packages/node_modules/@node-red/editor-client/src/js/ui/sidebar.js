...
RED.sidebar = (function() {
    ...
    function addTab(title,content,closeable,visible) {
        ...
        if (options.icon) {
            $('<i>',{style:"mask-image: url("+options.icon+"); -webkit-mask-image: url("+options.icon+");"}).appendTo(options.tabButton);
        } else if (options.iconClass) {
            $('<i>',{class:options.iconClass}).appendTo(options.tabButton);
        }
        options.tabButton.on('click', function() {
            const targetSidebar = options.target === 'secondary' ? sidebars.secondary : sidebars.primary;
    ...
    function moveTab(id, targetSidebar) {
    ...
    function setupSidebarTabs(sidebar) {
        const tabBar = $('<div class="red-ui-sidebar-tab-bar"></div>')
    ...
    function showSidebar(id, skipShowSidebar) {
        ...
        if (id) {
            ...
            if (tabOptions) {
                ...
                RED.settings.setLocal("last-sidebar-tab", tabOptions.id)
