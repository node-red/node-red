...
RED.subflow = (function() {
    ...
    var _subflowEditTemplate = '<script type="text/x-red" data-template-name="subflow">'+
        ...
        '<div class="form-row"><label data-i18n="[append]editor:editor-tab.properties"><i class="fa fa-list"></i> </label></div>'+
        '<div class="form-row node-input-env-container-row">'+
    ...
    function buildEnvForm(container, node) {
        ...
        envContainer
            ...
            .editableList({
                header: isTemplateNode?$('<div><div><div></div><div>Name</div><div>Default value</div><div></div></div></div>'):undefined,
    ...
    function buildEnvUIRow(row, tenv, ui) {
        ...
        switch(ui.type) {
            case "input":
                input = $('<input type="text">').css('width','100%').appendTo(row);
                ...
                break;
            case "select":
                input = $('<select>').css('width','100%').appendTo(row);
                if (ui.opts.opts) {
                    ui.opts.opts.forEach(function(o) {
            ...
            case "checkbox":
                ...
                // var cblabel = $('<label>').css('width','100%').appendTo(row);
                ...
                break;
            case "spinner":
                input = $('<input>').css('width','100%').appendTo(row);
                var spinnerOpts = {};
                ...
                input.spinner(spinnerOpts).parent().width('100%');
                input.val(val.value);
                break;
        }
        if (input) {
