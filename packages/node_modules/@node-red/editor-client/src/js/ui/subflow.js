...
RED.subflow = (function() {
    ...
    var _subflowTemplateEditTemplate = '<script type="text/x-red" data-template-name="subflow-template">'+
        ...
        '<div class="form-row" style="margin-bottom: 0px;"><label style="width: auto;" data-i18n="[append]editor:editor-tab.env"><i class="fa fa-th-list"></i> </label><div id="subflow-ui-control-buttons" style="float: right;"></div></div>'+
        '<div class="form-row" id="subflow-input-control"></div>'+
        '<div class="form-row node-input-env-container-row" id="subflow-input-edit-ui"><ol id="node-input-env-container"></ol></div>'+
        '<div id="subflow-input-env-locale"/>'+
        '<div id="subflow-input-ui"/>'+
        '</script>';
