    ...
    function exportNodes(mode, subflow) {
        ...
        $("#red-ui-clipboard-dialog-export-rng-group > a").on("click", function(evt) {
            ...
            if (subflow) {
                ...
                nodes = RED.nodes.createExportableNodeSet([sf], undefined, undefined, true, true);
            }
                ...
                nodes = RED.nodes.createExportableNodeSet(nodes.filter(function(n) { return n.type !== 'subflow'}), undefined, undefined, undefined, true);
            } else if (type === 'red-ui-clipboard-dialog-export-rng-flow') {
                var activeWorkspace = RED.workspaces.active();
                nodes = RED.nodes.filterNodes({z:activeWorkspace});
                var parentNode = RED.nodes.workspace(activeWorkspace)||RED.nodes.subflow(activeWorkspace);
                nodes.unshift(parentNode);
                nodes = RED.nodes.createExportableNodeSet(nodes, undefined, undefined, undefined, true);
            } else if (type === 'red-ui-clipboard-dialog-export-rng-full') {
                nodes = RED.nodes.createCompleteNodeSet(false, true);
            }
            if (nodes !== null) {
                if (format === "red-ui-clipboard-dialog-export-fmt-full") {
                    flow = JSON.stringify(nodes,null,4);
