...
RED.palette = (function() {
    ...
    function init() {
        ...
        RED.sidebar.addTab({
            target: 'secondary',
            id: "palette",
            label: RED._("sidebar.palette.label"),
            name: RED._("sidebar.palette.label"),
        ...
        RED.actions.add('core:show-palette-tab', () => {
            RED.sidebar.show("palette");
        })
        ...
        var paletteCollapseAll = $('<button type="button" class="red-ui-footer-button"><i class="fa fa-angle-double-up"></i></button>').attr('aria-label', RED._('palette.actions.collapse-all')).appendTo(paletteFooterButtons);
        ...
        var paletteExpandAll = $('<button type="button" class="red-ui-footer-button"><i class="fa fa-angle-double-down"></i></button>').attr('aria-label', RED._('palette.actions.expand-all')).appendTo(paletteFooterButtons);
