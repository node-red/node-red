...
RED.palette = (function() {
        ...
        if (exclusion.indexOf(def.category)===-1) {
            ...
            d.on("click", function() {
                ...
                if (nt.indexOf("subflow:") === 0) {
                    helpText = marked(getNodeInfo(RED.nodes.subflow(nt.substring(8))))||('<span class="red-ui-help-info-none">'+RED._("sidebar.info.none")+'</span>');
                } else {
            ...
            if (nt.indexOf("subflow:") === 0) {
                ...
                nodeInfo = marked(getNodeInfo(def));
            }
    ...
    function refreshNodeTypes() {
        RED.nodes.eachSubflow(function(sf) {
            ...
            setLabel(sf.type+":"+sf.id,paletteNode,sf.name,marked(getNodeInfo(sf)));
