...
RED.userSettings = (function() {
    ...
    // include / exclude code-editor choice settings based on browser
    var _isIE = /MSIE \d|Trident.*rv:/.test(navigator.userAgent) === true;
    if(!_isIE) { 
        viewSettings[2].options.push({setting:"view-node-code-editor",local: true, label:"menu.label.codeEditor", options:function(done){ done([{text:"ACE",val:"ACE"},{text:"Monaco",val:"MONACO"}]) }})
    }
