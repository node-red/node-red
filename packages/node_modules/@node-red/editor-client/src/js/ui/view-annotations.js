RED.view.annotations = (function() {
     ...
     *   tooltip: string|function(node) -> string
     *   popover: {
     *     content: function(node) -> jQuery
     *     direction: string,
     *     maxWidth: number,
     *     width: number|string,
    ...
    function refreshAnnotationElement(id, node, annotationGroup) {
        ...
        if (opts.popover?.content) {
            const direction = opts.popover.direction || 'top'
            const maxWidth = opts.popover.maxWidth || 400
            const width = opts.popover.width || 'auto'
            const delay = opts.popover.delay || { show: 350, hide: 150 }
            const popoverInstance = RED.popover.create({
                ...
                maxWidth,
                content: function() {
                    return opts.popover.content(node, popoverInstance)
                }
            })
