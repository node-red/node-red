...
RED.sidebar.help = (function() {
    ...
    function init() {
        ...
        var tocLabel = function () {
            return RED._(showTOCButton.hasClass('selected') ? "sidebar.help.hideTopics" : "sidebar.help.showTopics");
        };
        showTOCButton.attr('aria-label', tocLabel());
        RED.popover.tooltip(showTOCButton, tocLabel);
            ...
            if (item.tour) {
                ...
                if (typeof item.content === "string") {
                    ...
                    if (item.content.length === 0) {
                        ...
                        setInfoText(item.label, '<div class="red-ui-component-spinner red-ui-component-spinner-contain"><img src="red/images/spin.svg" alt="" /></div>',helpSection)
    ...
    function getChangelog(done) {
        $.get('red/about', function(data) {
            ...
            RED.tourGuide.load("./tours/welcome.js", function(err, tour) {
                var tourHeader = '<div><img width="50px" src="red/images/node-red-icon.svg" alt="Node-RED" /></div>';
                if (tour) {
