RED.contextMenu = (function () {
    ...
    function disposeMenu() {
        ...
        $(document).off("touchstart.red-ui-workspace-context-menu");
        if (menu) {
            menu.remove();
        }
        menu = null;
    ...
    function show(options) {
        ...
        $(document).on("touchstart.red-ui-workspace-context-menu", function (evt) {
            if (menu && menu[0].contains(evt.target)) {
                return
            }
            disposeMenu()
        ...
        // set focus to the menu itself so that pressing escape key closes it
        ...
        menu.on("keydown", function (evt) {
            ...
            evt.preventDefault()
            const items = menu.children("li:not(.disabled)").children("a")
            if (items.length === 0) {
                return
            }
