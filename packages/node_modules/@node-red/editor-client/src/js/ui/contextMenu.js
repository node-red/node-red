RED.contextMenu = (function () {
    ...
    function show(options) {
        ...
        if (menuHeight > spaceBelow - 10) {
            // Try repositioning above the click point first
            if (spaceAbove > spaceBelow && menuHeight <= spaceAbove - 10) {
                menu.css({
                    top: (top - menuHeight) + "px"
                });
            } else {
                // Enable scrolling with max available space above or below
