...
RED.sidebar.config = (function() {
    ...
    function init() {
        toolbar.find('#red-ui-sidebar-config-collapse-all').attr('aria-label', RED._('palette.actions.collapse-all'));
        toolbar.find('#red-ui-sidebar-config-expand-all').attr('aria-label', RED._('palette.actions.expand-all'));
        RED.sidebar.addTab({
            id: "config",
