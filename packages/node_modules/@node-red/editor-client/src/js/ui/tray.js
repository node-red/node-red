...
RED.tray = (function() {
        ...
        function finishBuild() {
            ...
            setTimeout(function() {
                setTimeout(function() {
                    ...
                    $('#red-ui-editor-stack').css("zIndex","13");//raise it above side-bar (fix for context menu clipping)
    ...
    return {
        ...
        close: function close(done) {
            if (stack.length > 0) {
                $('#red-ui-editor-stack').css("zIndex","9");//lower it below side-bar (related to fix for context menu clipping)
                var tray = stack.pop();
                tray.tray.css({
                    right: -(tray.tray.width()+10)+"px"
                });
