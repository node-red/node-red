 ...
 *    - delay : object - sets show/hide delays after pointerover/out events
 *                  { show: 750, hide: 50 }
 *    - autoClose : number - delay before closing the popover in some cases
 *                     if trigger is click - delay after pointerout
    ...
    function createPopover(options) {
        ...
        var openPopup = async function(instant) {
            ...
            if (active) {
                ...
                if (options.tooltip) {
                    div.on("pointerdown", function(evt) {
                        closePopup(true);
                    });
                }
                if (/*trigger === 'hover' && */options.interactive) {
                    div.on('pointerenter', function(e) {
                        clearTimeout(timer);
                        active = true;
                    })
                    div.on('pointerleave', function(e) {
                        if (timer) {
                            clearTimeout(timer);
                        }
                        if (active) {
                ...
                if (options.closeOnOutsideClick) {
                    ...
                    // (e.g. the popover's own click toggle, or a node's pointerdown handler)
                    ...
                    document.addEventListener('pointerdown', closeOnOutsideClickHandler, true);
                }
        ...
        var closePopup = function(instant) {
            isOpen = false
            $(document).off('pointerdown.red-ui-popover');
            $(window).off('resize.red-ui-popover.'+popoverId);
            if (closeOnOutsideClickHandler) {
                document.removeEventListener('pointerdown', closeOnOutsideClickHandler, true);
        ...
        if (trigger === 'hover') {
            target.on('pointerenter',function(e) {
                clearTimeout(timer);
                if (!active) {
                    active = true;
            ...
            target.on('pointerleave disabled', function(e) {
                if (timer) {
                    clearTimeout(timer);
                }
                if (active) {
            ...
            $(document).on('pointerdown.red-ui-popover', function (event) {
    ...
    return {
        ...
        tooltip: function(target,content, action, interactive) {
            ...
            popover.delete = function() {
                popover.close(true)
                target.off("pointerenter");
                target.off("pointerleave");
            };
            return popover;
        ...
        panel: function(content) {
            ...
            function hide(dispose) {
                $(document).off("pointerdown.red-ui-popover-panel-close");
            ...
            function show(options) {
                ...
                $(document).on("pointerdown.red-ui-popover-panel-close", function(event) {
