    ...
    function createTabs(options) {
        ...
        if (options.addButton) {
            ...
            if (typeof options.addButton === 'string') {
                ...
                addButton.find('a').attr('aria-label', l);
                RED.popover.tooltip(addButton,l,options.addButton);
            } else if (options.addButtonCaption) {
                addButton.find('a').attr('aria-label', options.addButtonCaption);
            }
        ...
        if (options.searchButton) {
            ...
            if (typeof options.searchButton === 'string') {
                ...
                searchButton.find('a').attr('aria-label', l);
                RED.popover.tooltip(searchButton,l,options.searchButton);
            } else if (options.searchButtonCaption) {
                searchButton.find('a').attr('aria-label', options.searchButtonCaption);
            }
        ...
        var tabAPI =  {
            addTab: function(tab,targetIndex) {
                ...
                const changeBadgeContainer = $('<svg class="red-ui-flow-tab-changed red-ui-flow-node-changed" width="10" height="10" viewBox="-1 -1 12 12"></svg>').appendTo(badges)
                ...
                const errorBadgeContainer = $('<svg class="red-ui-flow-tab-error red-ui-flow-node-error" width="10" height="10"></svg>').appendTo(badges)
