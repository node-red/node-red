...
RED.sidebar.info = (function() {
    ...
    function init() {
        ...
        var tipRefresh = $('<a href="#" class="red-ui-footer-button"><i class="fa fa-refresh"></a>').attr('aria-label', RED._('sidebar.info.nextTip')).appendTo(tipButtons);
        tipRefresh.on("click", function(e) {
            e.preventDefault();
            tips.next();
        })

        var tipClose = $('<a href="#" class="red-ui-footer-button"><i class="fa fa-times"></a>').attr('aria-label', RED._('sidebar.info.hideTips')).appendTo(tipButtons);
