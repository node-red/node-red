...
RED.view = (function() {
    ...
    function init() {
        ...
        $("#red-ui-view-searchtools-search").attr('aria-label', RED._('actions.search-flows')).on("click", searchFlows);
        RED.popover.tooltip($("#red-ui-view-searchtools-search"),RED._('actions.search-flows'),'core:search');
        $("#red-ui-view-searchtools-prev").attr('aria-label', RED._('actions.search-prev')).on("click", searchPrev);
        RED.popover.tooltip($("#red-ui-view-searchtools-prev"),RED._('actions.search-prev'),'core:search-previous');
        $("#red-ui-view-searchtools-next").attr('aria-label', RED._('actions.search-next')).on("click", searchNext);
        RED.popover.tooltip($("#red-ui-view-searchtools-next"),RED._('actions.search-next'),'core:search-next');
        $("#red-ui-view-searchtools-close").attr('aria-label', RED._('common.label.close'));
