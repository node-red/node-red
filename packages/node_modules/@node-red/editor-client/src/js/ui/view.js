    ...
    function redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            if (activeSubflow) {
                ...
                outGroup.append("g").attr('transform',attr_output_translate).append("rect").attr("class","port").attr("rx",3).attr("ry",3).attr("width",10).attr("height",10)
                ...
                inGroup.append("g").attr('transform',attr_input_translate).append("rect").attr("class","port").attr("rx",3).attr("ry",3).attr("width",10).attr("height",10)
                ...
                statusGroup.append("g").attr('transform', attr_status_translate).append("rect").attr("class","port").attr("rx",3).attr("ry",3).attr("width",10).attr("height",10)
                    .on("mousedown", function(d,i){portMouseDown(d,PORT_TYPE_INPUT,0);} )
                    .on("touchstart", function(d,i){portMouseDown(d,PORT_TYPE_INPUT,0);} )
                    .on("mouseup", function(d,i){portMouseUp(d,PORT_TYPE_INPUT,0);})
                    .on("touchend",function(d,i){portMouseUp(d,PORT_TYPE_INPUT,0);} )
