...
RED.view = (function() {
    ...
    function zoomToFitAll() {
        ...
        // Get all nodes and junctions in active workspace
        var nodesToFit = activeNodes.concat(activeJunctions);
        ...
        nodesToFit.forEach(function(node) {
            var width = node.type === "junction" ? 10 : node.w;
            var height = node.type === "junction" ? 10 : node.h;
            var nodeLeft = node.x - width / 2;
            var nodeRight = node.x + width / 2;
            var nodeTop = node.y - height / 2;
            var nodeBottom = node.y + height / 2;
