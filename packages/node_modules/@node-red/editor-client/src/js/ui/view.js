...
RED.view = (function() {
    ...
    function zoomToFitAll() {
        ...
        if (!activeNodes || activeNodes.length === 0) {
            console.log("zoomToFitAll: No active nodes found. activeNodes:", activeNodes);
            return; // No nodes to fit
        }

        console.log("zoomToFitAll: Found", activeNodes.length, "nodes");
        ...
        console.log("zoomToFitAll: targetZoom calculated:", targetZoom, "bounds:", {minX, minY, maxX, maxY}, "viewport:", {viewportWidth, viewportHeight});

        // Respect minimum and maximum zoom limits
        var minZoom = calculateMinZoom();
        targetZoom = Math.max(minZoom, Math.min(RED.view.zoomConstants.MAX_ZOOM, targetZoom));

        console.log("zoomToFitAll: clamped targetZoom:", targetZoom, "current scaleFactor:", scaleFactor);

        // Calculate center point of bounding box in workspace coordinates
        var centerX = (minX + maxX) / 2;
        var centerY = (minY + maxY) / 2;

        console.log("zoomToFitAll: center point:", centerX, centerY);
        ...
        if (Math.abs(scaleFactor - targetZoom) < 0.01) {
            console.log("zoomToFitAll: zoom unchanged, animating pan to center");
