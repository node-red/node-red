...
RED.workspaces = (function() {
    ...
    function addWorkspace(ws,skipHistoryEntry,targetIndex) {
        if (ws) {
            ...
            ws = {type:"tab",id:tabId,disabled: false,info:"",i18nInfo:{},label:RED._('workspace.defaultName',{number:workspaceIndex})};
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: function() {
                        ...
                        var i18nTexts = RED.editor.getTypeEditor('_markdown').getI18nTexts(tabflowEditor);
                        var info = "";
                        if (i18nTexts.hasOwnProperty("en-US")) {
                            info = i18nTexts["en-US"];
            ...
            open: function(tray) {
                ...
                var row = $('<div class="form-row node-text-editor-row">'+
                    ...
                    '<div style="min-height:250px;" class="node-text-editor" id="node-input-info"></div>'+
                            '</div>').appendTo(dialogForm);
                var i18nInfo = null;
                if (workspace.i18nInfo) {
                    i18nInfo = cloneObj(workspace.i18nInfo);
                    if (workspace.info) {
                        i18nInfo["en-US"] = workspace.info;
                    }
                }
                var value = workspace.info;
                ...
                $('#node-info-input-info-expand').on("click", function(e) {
                    ...
                    var i18nTexts = md.getI18nTexts(tabflowEditor);
                    var locale = md.getLocale(tabflowEditor);
