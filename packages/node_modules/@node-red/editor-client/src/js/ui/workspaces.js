...
RED.workspaces = (function() {
    ...
    function init() {
        ...
        RED.events.on("flows:validate", (flow) => {
            $("#red-ui-tab-" + (flow.id.replace(".", "-"))).toggleClass('red-ui-workspace-error', !!flow.contentsInvalid);
        });
        RED.events.on("subflows:validate", (subflow) => {
            $("#red-ui-tab-" + (subflow.id.replace(".", "-"))).toggleClass('red-ui-workspace-error', !!subflow.contentsInvalid);
        });
