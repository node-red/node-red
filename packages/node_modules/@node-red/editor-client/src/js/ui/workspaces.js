...
RED.workspaces = (function() {
    ...
    function addWorkspace(ws,skipHistoryEntry,targetIndex) {
        if (ws) {
            ...
            ws = {type:"tab",id:tabId,disabled: false,info:"",label:RED._('workspace.defaultName',{number:workspaceIndex}), spoutNodes:[]};
    ...
    function showEditWorkspaceDialog(id) {
        ...
        var trayOptions = {
            ...
            open: function(tray) {
                ...
                var spoutNodesTitle = $('<div class="form-row node-input-title-row>'+
                    '<label style="width:300px;">Spout nodes:</label>'+
                    '</div>').appendTo(dialogForm);
                var spoutNodesSelect = $('<div class="form-row node-input-spoutnodes-row">'+
                    ...
                    '</div>').appendTo(dialogForm);
                var spoutNodesList = $('<div class="form-row node-input-target-row node-input-spoutnode-list-row" style="min-height: 100px; height: 208px;">'+
