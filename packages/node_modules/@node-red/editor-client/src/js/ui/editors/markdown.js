...
(function() {
    ...
    var template = '<script type="text/x-red" data-template-name="_markdown">'+
        ...
        '<div id="red-ui-editor-type-markdown-panel-editor" class="red-ui-panel">'+
            '<div style="height: 100%; margin: auto; display: flex; flex-direction: column;">'+
                '<div id="red-ui-editor-type-markdown-toolbar"></div>'+
                '<div class="node-text-editor" style="flex: 1; min-height: 0;" id="red-ui-editor-type-markdown"></div>'+
            '</div>'+
        '</div>'+
        ...
        show: function(options) {
            ...
            var trayOptions = {
                ...
                open: function(tray) {
                    ...
                    if (options.footer) {
                        options.footer(
                            $("#red-ui-editor-type-markdown-panel-editor > div"),
                            expressionEditor
                        );
                    }
                    var changeTimer;
