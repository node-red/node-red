...
RED.editor.codeEditor.basic = (function() {
    ...
    function create(options) {
        ...
        const el = options.element || $("#"+options.id)[0];
        ...
        textarea.css({ width: "100%", height: "100%", fontFamily: "monospace" });
        ...
        ed.scrollToLine = function scrollToLine(lineNumber, scrollType) {
            ...
            console.log({ lineNumber, lineHeight, scrollTop })
            if (scrollType === 0) {
                textarea.scrollTo({
                    top: scrollTop,
                    behavior: "smooth"
        ...
        ed.saveView = function (debuginfo) {
            ...
            // use jquery data() to store view state
            const selection = {
