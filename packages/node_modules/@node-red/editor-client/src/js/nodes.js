...
RED.nodes = (function() {
    ...
    function convertNode(n, exportCreds) {
        ...
        if (n.i18nInfo) {
            var i18nInfo = trimEmptyInfo(n.i18nInfo);
            if (i18nInfo) {
                node.i18nInfo = i18nInfo;
            }
        }
        return node;
    }
    ...
    function checkForMatchingSubflow(subflow,subflowNodes) {
        ...
        RED.nodes.eachSubflow(function(sf) {
            if (sf.name != subflow.name ||
                ...
                !isSameI18nInfo(sf.i18nInfo, subflow.i18nInfo) ||
    ...
    function importNodes(newNodesObj,createNewIds,createMissingWorkspace) {
        ...
        if (defaultWorkspace == null) {
            defaultWorkspace = { type:"tab", id:getID(), disabled: false, info:"", i18nInfo:{}, label:RED._('workspace.defaultName',{number:1})};
