...
#red-ui-header {
    ...
    ul.red-ui-menu-dropdown {
        ...
        @include mixins.menu-scrollbar-dark;
    }
...
// Standalone class for header-style sub menus since we need to reapply the styles due to lost inheritance
.red-ui-header-menu {
    &.red-ui-menu-dropdown {
        @include mixins.menu-dark-theme;
        @include mixins.menu-scrollbar-dark;
        width: 260px;
    }
}
