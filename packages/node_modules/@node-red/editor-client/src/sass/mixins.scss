...
// Dark theme menu styles (for header menus and portaled dark-theme submenus)
@mixin menu-dark-theme {
    ...
    a .red-ui-popover-key {
        color: var(--red-ui-header-menu-color-disabled);
        border-color: var(--red-ui-header-menu-color-disabled);
    }
...
@mixin menu-scrollbar-dark {
    ...
    &::-webkit-scrollbar-thumb {
        background: var(--red-ui-header-menu-color-disabled);
        border-radius: 4px;
    }
    &::-webkit-scrollbar-thumb:hover {
        background: var(--red-ui-header-menu-color);
    }
    // Firefox scrollbar styling
    scrollbar-width: thin;
    scrollbar-color: var(--red-ui-header-menu-color-disabled) var(--red-ui-header-menu-background);
}
