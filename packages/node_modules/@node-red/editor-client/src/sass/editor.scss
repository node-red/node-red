...
.red-ui-editor-subflow-env-row {
    transition: all 0.2s linear;
}
.red-ui-editor-subflow-env-row.down {
...
.red-ui-editor-subflow-ui-grid {
    ...
    td {
        ...
        .uneditable-input {
            position: relative;
            padding: 0;
            .red-ui-typedInput-type-select .red-ui-typedInput-icon {
                margin-right: 8px;
            }
            .red-ui-typedInput-option-trigger .red-ui-typedInput-icon {
                margin-left: 8px;
                margin-right: 6px;
            }
            > div {
        ...
        input,.uneditable-input,select,.ui-spinner {
            width: 90%;
        }
        input[type="checkbox"] {
            margin-top: 0;
