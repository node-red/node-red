...
#red-ui-editor-shade, #red-ui-header-shade, .red-ui-sidebar-shade  {
...
:root {
    scrollbar-color: var(--red-ui-scrollbar-handle-background) var(--red-ui-primary-background);
    scrollbar-width: thin;

    // Fallback for browsers that don't support the standard scrollbar-color
    // property (Safari < 18.2, Chrome < 121). Modern browsers use the rules
    // above; older Chromium/WebKit falls back to these pseudo-elements.
    @supports not (scrollbar-color: red) {
        ...
        ::-webkit-scrollbar-thumb {
            background-color: var(--red-ui-scrollbar-handle-background);
            border-radius: 4px;

            &:hover {
                background-color: var(--red-ui-scrollbar-handle-background-hover);
            }
        }
