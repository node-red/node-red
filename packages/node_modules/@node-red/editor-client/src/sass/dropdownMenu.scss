...
.red-ui-menu-dropdown-portaled {
    @include mixins.menu-light-theme;
    position: fixed;
    z-index: 1001;
    display: block;
    margin: 0;
    ...
    // The noicons padding rule (0-2-1) beats menu-light-theme (0-1-1), so restore
    // the correct padding here where it comes later in source order (same specificity wins)
    &.red-ui-menu-dropdown-noicons > li > a,
    &.red-ui-menu-dropdown-noicons > li > a:focus {
...
.red-ui-menu-dropdown {
    @include mixins.menu-scrollbar-light;
}
