 ...
 **/
 ...
 $view-grid-color: rgba(0,0,0,0.1);
 
 $node-label-color: #f5f5f5;
 $node-port-label-color: #f5f5f5;
 $node-border: #999999;
 $node-border-unknown: #f33;
 $node-border-placeholder: #999999;
 $node-background-placeholder: #e0e0e0;
 
 $node-port-background: #d9d9d9;
 $node-port-background-hover: #ff7f0e;
 $node-icon-color: #fff;
 $node-icon-background-color: #999999;
 $node-icon-background-color-fill: #999999;
