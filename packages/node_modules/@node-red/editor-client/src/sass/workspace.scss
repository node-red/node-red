...
.red-ui-tab:not(.red-ui-workspace-error) .red-ui-flow-tab-error {
    display: none;
}
.red-ui-tab:not(.red-ui-workspace-changed).red-ui-workspace-error .red-ui-flow-tab-error {
    display: inline-block;
    position: absolute;
    top: 1px;
    right: 1px;
}
.red-ui-tab.red-ui-workspace-error .red-ui-flow-tab-error {
    display: inline-block;
    position: absolute;
    top: 1px;
    right: 12px;
...
.red-ui-workspace-scrollbar-handle {
    position: absolute;
    pointer-events: auto;
    background: color-mix(in srgb, var(--red-ui-scrollbar-handle-background) 60%, transparent);
    border-radius: 4px;
    box-sizing: border-box;
