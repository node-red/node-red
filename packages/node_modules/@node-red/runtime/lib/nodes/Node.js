...
Node.prototype.send = function(msg) {
    ...
    if (msg === null || typeof msg === "undefined") {
        ...
        if (this._wire) {
            ...
            this.metric("send",msg); if (!this._flow.incrPendingMsgId) { console.log('nofunc:'+this._flow);}
            this._flow.incrPendingMsgId(msg._msgid);
            this._flow.send([{
                msg: msg,
                source: {
                    id: this.id,
                ...
                for (var j = 0; j < wires.length; j++) {
                    ...
                    for (k = 0; k < msgs.length; k++) {
                        ...
                        if (m !== null && m !== undefined) {
                            ...
                            this._flow.incrPendingMsgId(m._msgid);
                            sendEvents.push({
                                msg: m,
                                source: {
                                    id: this.id,
