 ...
 */
function setFlows(_config,type,muteLog,forceStart,opt) {
    type = type||"full";
    ...
    return configSavePromise
        .then(function(flowRevision) {
            var cred = (opt && opt.hasOwnProperty("credentials")) ? opt.credentials : null;
            if (!isLoad) {
            ...
            if (forceStart || started) {
                ...
                return stop(type,diff,muteLog).then(() => {
                    ...
                    var credPromise = (cred ? _runtime.nodes.loadCredentials(cred) : Promise.resolve());
