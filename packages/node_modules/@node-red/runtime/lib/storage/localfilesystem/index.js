...
var localfilesystem = {
    ...
    saveFlows: flows.saveFlows,
    getCredentials: flows.getCredentials,
    saveCredentials: flows.saveCredentials,
    ...
    // This storage module stores flows on the local filesystem as a single
    // flows.json, and supports versioning them with the built-in "git" project
    // type. The runtime projects service selects the type and drives it with the
    // flow layout below (an internal seam, not part of the storage plugin
    // contract). A storage module wanting a different layout exposes its own.
    getProjectType: function() { return "git"; },
    getFlowLayout: function() { return flows.layout; }
};
