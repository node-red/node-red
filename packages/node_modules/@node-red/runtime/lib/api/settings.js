        ...
        return new Promise(function(resolve,reject) {
            try {
                ...
                if (!runtime.settings.disableEditor) {
                    ...
                    if (runtime.settings.editor) {
                        safeSettings.editor = runtime.settings.editor || {};
                        safeSettings.editor.lib = safeSettings.editor.lib || "MONACO";
                        safeSettings.editor.options = safeSettings.editor.options || {};
                    }
