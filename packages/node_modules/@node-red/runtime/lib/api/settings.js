    ...
    */
    getRuntimeSettings: async function(opts) {
        ...
        if (!runtime.settings.disableEditor) {
            ...
            if (runtime.settings.subflowModule) {
                safeSettings.subflowModule = safeSettings.subflowModule || {};
                safeSettings.subflowModule.allowDownload
                    = runtime.settings.subflowModule.allowDownload;
                safeSettings.subflowModule.templateDir
                    = runtime.settings.subflowModule.templateDir;
                safeSettings.subflowModule.allowEncoding
                    = runtime.settings.subflowModule.allowEncoding;
            }
            if (runtime.settings.encodeSubflow) {
                safeSettings.encodeSubflow = runtime.settings.encodeSubflow;;
            }
