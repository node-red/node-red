    ...
    setFlows: function(opts) {
        return new Promise(function(resolve,reject) {
            ...
            if (deploymentType === 'reload') {
                ...
                var cred = flows.hasOwnProperty("credentials") ? flows.credentials : undefined;
                apiPromise = runtime.nodes.setFlows(flows.flows,deploymentType, undefined, undefined, {credentials: cred});
            }
