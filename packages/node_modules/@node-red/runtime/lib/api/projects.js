...
var api = module.exports = {
    ...
    available: async function(opts) {
        return runtime.projects.available();
    },
    /**
    ...
    */
    listProjects: async function(opts) {
        return runtime.projects.listProjects(opts.user).then(function(list) {
            var active = runtime.projects.getActiveProject(opts.user);
            var response = {
                projects: list
            };
            if (active) {
    ...
    */
    createProject: async function(opts) {
        ...
        return runtime.projects.createProject(opts.user, opts.project)
    },
    ...
    */
    initialiseProject: async function(opts) {
        ...
        return runtime.projects.initialiseProject(opts.user, opts.id, opts.project)
    },
    ...
    */
    getActiveProject: async function(opts) {
        return runtime.projects.getActiveProject(opts.user);
    },
    ...
    */
    setActiveProject: async function(opts) {
        var currentProject = runtime.projects.getActiveProject(opts.user);
        runtime.log.audit({event: "projects.set",id:opts.id}, opts.req);
        if (!currentProject || opts.id !== currentProject.name) {
            return runtime.projects.setActiveProject(opts.user, opts.id, opts.clearContext);
        }
    },
    ...
    */
    getProject: async function(opts) {
        return runtime.projects.getProject(opts.user, opts.id)
    },
    ...
    */
    updateProject: async function(opts) {
        ...
        return runtime.projects.updateProject(opts.user, opts.id, opts.project);
    },
    ...
    */
    deleteProject: async function(opts) {
        ...
        return runtime.projects.deleteProject(opts.user, opts.id);
    },
    ...
    */
    getStatus: async function(opts) {
        return runtime.projects.getStatus(opts.user, opts.id, opts.remote)
    },
    ...
    */
    getBranches: async function(opts) {
        return runtime.projects.getBranches(opts.user, opts.id, opts.remote);
    },
    ...
    */
    getBranchStatus: async function(opts) {
        return runtime.projects.getBranchStatus(opts.user, opts.id, opts.branch);
    },
    ...
    */
    setBranch: async function(opts) {
        ...
        return runtime.projects.setBranch(opts.user, opts.id, opts.branch, opts.create)
    },
    ...
    */
    deleteBranch: async function(opts) {
        ...
        return runtime.projects.deleteBranch(opts.user, opts.id, opts.branch, false, opts.force);
    },
    ...
    */
    commit: async function(opts) {
        ...
        return runtime.projects.commit(opts.user, opts.id,{message: opts.message});
    },
    ...
    */
    getCommit: async function(opts) {
        return runtime.projects.getCommit(opts.user, opts.id, opts.sha);
    },
    ...
    */
    getCommits: async function(opts) {
        return runtime.projects.getCommits(opts.user, opts.id, {
            limit: opts.limit || 20,
            before: opts.before
        });
    },
    ...
    */
    abortMerge: async function(opts) {
        ...
        return runtime.projects.abortMerge(opts.user, opts.id);
    },
    ...
    */
    resolveMerge: async function(opts) {
        ...
        return runtime.projects.resolveMerge(opts.user, opts.id, opts.path, opts.resolution);
    },
    ...
    */
    getFiles: async function(opts) {
        return runtime.projects.getFiles(opts.user, opts.id);
    },
    ...
    */
    getFile: async function(opts) {
        return runtime.projects.getFile(opts.user, opts.id,opts.path,opts.tree);
    },
    ...
    */
    stageFile: async function(opts) {
        ...
        return runtime.projects.stageFile(opts.user, opts.id, opts.path);
    },
    ...
    */
    unstageFile: async function(opts) {
        ...
        return runtime.projects.unstageFile(opts.user, opts.id, opts.path);
    },
    ...
    */
    revertFile: async function(opts) {
        ...
        return runtime.projects.revertFile(opts.user, opts.id,opts.path)
    },
    ...
    */
    getFileDiff: async function(opts) {
        return runtime.projects.getFileDiff(opts.user, opts.id, opts.path, opts.type);
    },
    ...
    */
    getRemotes: async function(opts) {
        return runtime.projects.getRemotes(opts.user, opts.id);
    ...
    */
    addRemote: async function(opts) {
        ...
        return runtime.projects.addRemote(opts.user, opts.id, opts.remote)
    },
    ...
    */
    removeRemote: async function(opts) {
        ...
        return runtime.projects.removeRemote(opts.user, opts.id, opts.remote);
    },
    ...
    */
    updateRemote: async function(opts) {
        ...
        return runtime.projects.updateRemote(opts.user, opts.id, opts.remote.name, opts.remote)
    },
    ...
    */
    pull: async function(opts) {
        ...
        return runtime.projects.pull(opts.user, opts.id, opts.remote, opts.track, opts.allowUnrelatedHistories);
    },
    ...
    */
    push: async function(opts) {
        ...
        return runtime.projects.push(opts.user, opts.id, opts.remote, opts.track);
    }
