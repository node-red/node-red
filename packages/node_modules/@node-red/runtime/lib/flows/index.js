...
async function addFlow(flow, user) {
    ...
    if (flow.hasOwnProperty('spoutNodes')) {
        tabNode.spoutNodes = flow.spoutNodes;
    }
    if (flow.hasOwnProperty('shutdownBehaviour')) {
        tabNode.shutdownBehaviour = flow.shutdownBehaviour;
    }
...
function getFlow(id) {
    ...
    if (flow.hasOwnProperty('spoutNodes')) {
        result.spoutNodes = flow.spoutNodes;
    }
    if (flow.hasOwnProperty('shutdownBehaviour')) {
        result.shutdownBehaviour = flow.shutdownBehaviour;
    }
    if (id !== 'global') {
        result.nodes = [];
    }
...
async function updateFlow(id,newFlow, user) {
    ...
    if (id === 'global') {
        ...
        if (newFlow.hasOwnProperty('spoutNodes')) {
            tabNode.spoutNodes = newFlow.spoutNodes;
        }
        if (newFlow.hasOwnProperty('shutdownBehaviour')) {
            tabNode.shutdownBehaviour = newFlow.shutdownBehaviour;
        }
