...
module.exports = {
    // Repo skeleton only. The flow file references in node-red.settings are
    // recorded by the storage layout (layout.buildPackageSettings), since which
    // files hold the flows is the layout's business, not the git type's.
