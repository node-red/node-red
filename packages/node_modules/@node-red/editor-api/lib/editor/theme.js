...
function init() {
    ...
    defaultContext = {
        ...
        asset: {
            ...
            vendorMonaco: (codeEditorSettings && codeEditorSettings.lib === "monaco") ? "vendor/monaco/monaco-bootstrap.js" : "",
        }
    };
...
module.exports = {
    init: function(settings, _runtimeAPI) {
        ...
        codeEditorSettings =  theme.codeEditor || {};
