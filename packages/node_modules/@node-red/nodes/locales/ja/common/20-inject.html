...
<script type="text/html" data-help-name="inject">
  ...
  <hr/>
  <p>「日付の週」、「日付までの間隔」、「詳細」、「crontime」、および「date」機能は、<a href="https://www.npmjs.com/package/cronti" target="_blank">cronti</a>パッケージを使用して作成されます。 詳細については、<a href="https://buglss.github.io/npm/cronti/v2/" target="_blank">cronti</a>リンクをクリックしてください。</p>
  </script>
