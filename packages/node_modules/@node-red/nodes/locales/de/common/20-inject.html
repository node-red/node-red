...
<script type="text/html" data-help-name="inject">
  <p>Injiziert eine Nachricht manuell oder in regelmäßigen Intervallen in einen Flow.
  ...
  <dl class="message-properties">
    ...
    <dd>Die eingestellten Nutzdaten (Payload) der Nachricht.</dd>
    <dt class="optional">topic<span class="property-type">Zeichenfolge (string)</span></dt>
    <dd>Eine optional nutzbare Nachrichten-Eigenschaft.</dd>
  </dl>
  <h3>Details</h3>
  ...
  <p>Das maximal einstellbare Intervall beträgt etwa 596 Stunden bzw. 24 Tage.
    Wenn jedoch Intervalle grösser als 24h benötigt werden, sollte ein scheduler-Node verwendet werden,
