...
<script type="text/html" data-help-name="catch">
  <p>Fängt Fehler von Nodes in der selben Flow-Registerkarte ab.</p>
  <h3>Ausgangsdaten</h3>
  <dl class="message-properties">
    <dt>error.message<span class="property-type">Zeichenfolge (string)</span></dt>
    <dd>Die Fehlermeldung.</dd>
    <dt>error.source.id<span class="property-type">Zeichenfolge (string)</span></dt>
    <dd>Die ID des fehlerauslösenden Nodes.</dd>
    <dt>error.source.type<span class="property-type">Zeichenfolge (string)</span></dt>
    <dd>Der Typ des fehlerauslösenden Nodes.</dd>
    <dt>error.source.name<span class="property-type">Zeichenfolge (string)</span></dt>
    <dd>Der Name des fehlerauslösenden Nodes (falls festgelegt).</dd>
  </dl>
  <h3>Details</h3>
