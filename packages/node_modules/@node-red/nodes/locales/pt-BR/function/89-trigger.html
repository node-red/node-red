...
<script type="text/html" data-help-name="trigger">
  ...
  <dl class = "message-properties">
      ...
      <dd> Se for recebida uma mensagem com esta propriedade, qualquer timeout ou repetição
  ...
  <p> Os payloads de cada mensagem enviada podem ser configurados com uma variedade de valores, incluindo
  ...
  atua como um cronômetro de vigilância; apenas enviando uma mensagem se nada for recebido dentro do
  definir intervalo. </p>
  <p> Se definido como um tipo <i> string </i>, o nó suporta a sintaxe de modelo de bigode. </p>
  ...
  que corresponde ao configurado no nó, qualquer tempo limite ou repetir atualmente em
  ...
  é redefinido por uma mensagem recebida. </p>
  ...
  <p> O status indica que o nó está ativo no momento. Se vários fluxos forem usados, o status
