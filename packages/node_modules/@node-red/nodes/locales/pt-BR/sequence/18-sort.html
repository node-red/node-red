...
<script type="text/html" data-help-name="sort">
    ...
    <p> Quando configurado para classificar uma sequência de mensagens, ele reordenará as mensagens. </p>
    ...
    <p> <b> Nota: </b> Este nodo mantém internamente mensagens para sua operação. Para evitar o uso inesperado da memória, o número máximo de mensagens mantidas pode ser especificado. O padrão não tem limite de número de mensagens.
        <ul>
