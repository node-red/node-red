...
<script type="text/html" data-help-name="debug">
  ...
  <p> Objetos e matrizes JavaScript podem ser recolhidos e expandidos conforme necessário. Objetos de buffer podem ser exibidos como dados brutos ou como uma string, se possível. </p>
  ...
  <p> O nó também pode ser configurado para enviar todas as mensagens para o log de tempo de execução ou para enviar mensagens curtas (32 caracteres) para o texto de status no nó de depuração. </p> 
</script>
