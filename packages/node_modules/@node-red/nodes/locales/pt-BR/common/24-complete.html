...
<script type="text/html" data-help-name="complete">
    <p> Acione um fluxo quando outro nó concluir o tratamento de uma mensagem. </p>
    <h3> Detalhes </h3>
    <p> Se um nó informar ao tempo de execução quando terminar de lidar com uma mensagem,
        este nó pode ser usado para acionar um segundo fluxo. </p>
    <p> Por exemplo, isso pode ser usado ao lado de um nó sem porta de saída,
    ...
    <p> Este nó deve ser configurado para lidar com o evento para nós selecionados no
        fluxo. Ao contrário do nó Catch, ele não fornece um modo 'manipular todos' automaticamente
        se aplica a todos os nós no fluxo. </p>
