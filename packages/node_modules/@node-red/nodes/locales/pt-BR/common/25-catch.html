...
<script type="text/html" data-help-name="catch">
  ...
  <p> Capture erros lançados por nós na mesma guia. </p>
      ...
      <p> Se um nó lançar um erro ao lidar com uma mensagem, o fluxo normalmente
         pare. Este nó pode ser usado para capturar esses erros e tratá-los com um
         fluxo dedicado. </p>
      <p> Por padrão, o nó detectará erros lançados por qualquer nó na mesma guia. alternativamente
      ...
      <p> Quando um erro é lançado, todos os nós catch correspondentes receberão a mensagem. </p>
      <p> Se um erro for lançado em um subfluxo, o erro será tratado por qualquer
         capturar nós dentro do subfluxo. Se nenhum existir, o erro será propagado
