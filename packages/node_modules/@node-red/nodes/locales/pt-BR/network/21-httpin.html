...
<script type="text/html" data-help-name="http in">
    ...
    <dl class = "message-properties">
        <dt> carga útil </dt>
        <dd> Para uma solicitação GET, contém um objeto de qualquer parâmetro de string de consulta.
        ...
        <dd> Um objeto de resposta HTTP. Esta propriedade não deve ser usada diretamente;
            o nó <code> Resposta HTTP </code> documenta como responder a uma solicitação.
    ...
    <p> O nó escutará no caminho configurado para solicitações de um tipo particular.
       ...
       Quando parâmetros nomeados são usados, seu valor real em uma solicitação pode ser acessado em <code> msg.req.params </code>. </p>
    ...
    <p> Se o tipo de conteúdo da solicitação puder ser determinado, o corpo será analisado para
       qualquer tipo apropriado. Por exemplo, <code> application / json </code> será analisado para
       sua representação de objeto JavaScript. </p>
    <p> <b> Observação: </b> este nó não envia nenhuma resposta à solicitação. O fluxo
...
<script type="text/html" data-help-name="http response">
    ...
    <h3> Entradas </h3>
    <dl class = "message-properties">
        <dt> carga útil <span class = "property-type"> string </span> </dt>
        <dd> O corpo da resposta. </dd>
        <dt class = "optional"> statusCode <span class = "property-type"> número </span> </dt>
        <dd> Se definido, é usado como código de status de resposta. Padrão: 200. </dd>
    ...
    o próprio nó. Se uma propriedade for definida dentro do nó, ela não pode ser substituída
    ...
    O valor pode ser uma string para definir o valor do cookie com o padrão
    opções, ou pode ser um objeto de opções. </p>
    <p> O exemplo a seguir define dois cookies - um chamado <code> nome </code> com
    um valor de <code> nick </code>, o outro chamado <code> sessão </code> com um
    ...
    <ul>
    <li><code>domain</code> - (String) nome de domínio para o cookie</li>
    ...
    <li><code>maxAge</code> - (String) data de expiração em relação à hora atual em milissegundos</li>
    <li><code>path</code> - (String) caminho para o cookie. Padrões para /</li>
    <li><code>value</code> - (String) o valor a ser usado para o cookie</li>
    </ul>
    <p> Para excluir um cookie, defina seu <code> valor </code> como <code> null </code>. </p>
