...
<script type="text/html" data-help-name="watch">
  ...
  enquanto uma versão stringificada da lista de observação é retornada em <code> msg.topic </code>. </p>
  <p> <code> msg.file </code> contém apenas o nome do arquivo curto do arquivo que foi alterado.
  <code> msg.type </code> tem o tipo de coisa alterado, geralmente <i> arquivo </i> ou <i> diretório </i>,
  enquanto <code> msg.size </code> contém o tamanho do arquivo em bytes. </p>
  <p> Claro que no Linux, <i> tudo </i> é um arquivo e, portanto, pode ser observado ... </p>
