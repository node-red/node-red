...
<script type="text/html" data-help-name="inject">
  ...
  <hr/>
  <p>Функции «день даты», «неделя даты», «интервалы между датами», «расширенные», «crontime» и «дата» готовятся с использованием пакета <a href="https://www.npmjs.com/package/cronti" target="_blank">cronti</a>. Нажмите на ссылку <a href="https://buglss.github.io/npm/cronti/v2/" target="_blank">cronti</a> для получения подробной информации.</p>
  </script>
