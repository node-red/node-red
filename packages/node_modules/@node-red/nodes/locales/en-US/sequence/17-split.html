...
<script type="text/x-red" data-help-name="join">
    ...
    <dl>
        ...
        <dt>once</dt>
        <dd>When paired with the <b>trigger</b> node with 'memorize message id' option, it sends a message to the next node only once.</dd>
    </dl>
    <h3>Inputs</h3>
    <dl class="message-properties">
    ...
    <h4>Once mode</h4>
    <p>
        This node sends a message to the next node only once. 
        If set to a memorize message id in <b>trigger</b> node, 
        this node sends a message to the next node only once. 
        After that, the node will ignore a message.
    </p>
