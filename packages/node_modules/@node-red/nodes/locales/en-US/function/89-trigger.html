...
<script type="text/x-red" data-help-name="trigger">
    ...
    <p>If setting a second message, this node can discrete outputs and memorize ids. When set to discrete outputs, 
    this node has a second output port. When it receives a message, it sends a message to the first port. 
    It then waits setting times before sending a second message to the other port.
    If set to a memorize message ids, this node memorises the message id in the flow context. It use this option 
    in combination with the once mode of the <b>join</b> node.
    </p>
</script>
