...
<script type="text/html" data-help-name="inject">
    <p>Vloží správu do toku manuálne alebo v pravidelných intervaloch. Obsah správy správy
    ...
    <dl class="message-properties">
        ...
        <dd>Konfigurovaný Obsah správy správy.</dd>
    ...
    <h3>Detaily</h3>
    <p>Uzol Vložiť môže iniciovať tok so špecifickou hodnotou Obsah správyu.
      Predvolený Obsah správy je časová pečiatka aktuálneho času v milisekundách od 1. januára 1970.</p>
    ...
    <p><b>Poznámka</b>: Na zahrnutie nového riadku do reťazca musíte použiť buď funkčný uzol alebo uzol šablóny na vytvorenie Obsah správyu.</p>
</script>