...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        // `returnLinkMessage` is a callback invoked by a `link out` node in `return` mode to
        // deliver the result of a visual subroutine back to its caller (see core/common/60-link.js).
