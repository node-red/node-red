        ...
        var sandbox = {
            ...
            RED: {
                util: {
                    ...
                    linkcall: async function (target, msg, options) {
                        try {
                            if (typeof target !== "string" || target.trim() === "") {
                                throw new Error(RED._("function.error.linkcall.targetInvalid"));
                            }
                            if (typeof msg !== "object" || msg === null) {
                                throw new Error(RED._("function.error.linkcall.msgInvalid"));
                            }
                            options = options || {};
                            ...
                            if (!targetNode || targetNode.type !== 'link in') {
                                throw new Error(RED._("function.error.linkcall.targetInvalid",{id:target}));
                            }
                            ...
                            messageEvents[messageEvent.id] = {
                                ...
                                options: options,
                                send: function () {
                                    console.log("linkcall message send called - but by who?");
                                    debugger
                                },
                                done: function () {
                                    console.log("linkcall message done called - but by who?");
                                    debugger
                                },
