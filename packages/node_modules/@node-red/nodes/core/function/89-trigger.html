...
<script type="text/javascript">
    RED.nodes.registerType('trigger',{
        ...
        oneditprepare: function() {
            ...
            if (this.func === "block" || this.duration == "0" || this.duration == 0) {
                this.func = "block";
                $("#node-then-type").val("block");
            }
            else if (this.func === "loop" || this.duration < 0) {
                if (this.duration < 0)
                {
