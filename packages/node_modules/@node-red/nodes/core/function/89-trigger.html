...
<script type="text/x-red" data-template-name="trigger">
    ...
    <div class="form-row node-type-wait">
        <label></label>
        <input type="checkbox" id="node-input-discrete" style="margin-left: 0px; vertical-align: top; width: auto !important;"> <label style="width:auto !important;" for="node-input-discrete">discrete outputs</label>
        <input type="hidden" id="node-input-outputs" value="1">
        <input type="checkbox" id="node-input-memorize" style="margin-left: 0px; vertical-align: top; width: auto !important;"> <label style="width:auto !important;" for="node-input-memorize">memorize message ids</label>
    </div>
    <div class="form-row">
        ...
        oneditprepare: function() {
            $("#node-then-type").on("change", function() {
                if ($(this).val() == "block") {
                    ...
                    $("#node-input-discrete").prop("checked",false);
                    $("#node-input-memorize").prop("checked",false);
                }
            ...
            $("#node-input-discrete").on("change", function() {
