...
module.exports = function(RED) {
    ...
    function TriggerNode(n) {
        ...
        this.discrete = n.discrete || "false";
        this.memorize = n.memorize || "false";
        ...
        var processMessage = function(msg) {
            ...
            if (node.memorize === true) {
                RED.util.evaluateNodeProperty('memorize','flow',node,msg);
                var context = RED.util.parseContextStore("memorize");
                var target = node.context()['flow'];
                target.set(context.key, msg._msgid, context.store, function (err) {
                    if(err) {
                        node.error(err,msg);
                    }
                });
