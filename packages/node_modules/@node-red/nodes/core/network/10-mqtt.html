...
<script type="text/html" data-template-name="mqtt control">
    ...
    <div class="form-row">
        ...
        <div id="node-mqtt-control-action-tip" class="form-tips" style="width: calc(70% - 14px); vertical-align: middle; border-radius: 4px;  padding: 6px; display: inline-block"> </div>
    </div>
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span data-i18n="common.label.name"></span></label>
