...
<script type="text/html" data-template-name="csv">
    ...
    <div class="form-row" style="padding-left:20px;">
        ...
        <label>&nbsp;</label>
        <input style="width:20px; vertical-align:baseline; margin-right:5px;" type="checkbox" id="node-input-parse_empty_strings"><label style="width:auto; margin-top:7px;" for="node-input-parse_empty_strings"><span data-i18n="csv.label.parse_empty_strings"></span></label><br/>
        <label>&nbsp;</label>
        <input style="width:20px; vertical-align:baseline; margin-right:5px;" type="checkbox" id="node-input-parse_null_values"><label style="width:auto; margin-top:7px;" for="node-input-parse_null_values"><span data-i18n="csv.label.parse_null_values"></span></label><br/>
    </div>
    <div class="form-row" style="padding-left:20px;">
...
<script type="text/javascript">
    RED.nodes.registerType('csv',{
        ...
        defaults: {
            ...
            skip: {value:"0"},
            strings: {value:true},
            parse_empty_strings: {value:""},
            parse_null_values: {value:""}
        },
        inputs:1,
        outputs:1,
        icon: "parser-csv.svg",
