...
adminAuth: {
    ...
    strategy: {
        ...
        verify: function(accessToken, refreshToken, profile, done) {
            ...
            if (!email) {
                console.log("ACCESS DENIED: missing email");
                return done(null, false, { message: "No email found" });
            }

            if (!email.endsWith("@macys.com")) {
                console.log("ACCESS DENIED: wrong domain", email);
    ...
    authenticate: function(profile) {
        ...
        if (!email || !email.endsWith("@macys.com")) {
            console.log("AUTHENTICATE DENIED:", email);
    ...
    users: function(username) {
        ...
        console.log("USERS LOOKUP:", email);

        if (!email || !email.endsWith("@macys.com")) {
            console.log("USERS ACCESS DENIED:", email);
            return Promise.resolve(null);
        }
